export type Channel = 'Сказать' | 'Радио' | 'Действие' | 'OOC' | 'Админ';
...
export class ChannelIterator {
  ...
  private readonly channels: Channel[] = ['Сказать', 'Радио', 'Действие', 'OOC', 'Админ'];
  private readonly blacklist: Channel[] = ['Админ'];
  private readonly quiet: Channel[] = ['OOC', 'Админ'];
  ...
  public isSay(): boolean {
    return this.channels[this.index] === 'Сказать';
  }
