import { Box, Button, Section, DraggableClickableControl, Dropdown, NoticeBox } from '../components';
            ...
            <Button
              ...
              tooltip={
                <Section title="Как это работает">
                  <Box color="blue">
                    1. Нажми <b>&#39;ПИНГ&#39;</b> для
                    радарного импульса.
                  </Box>
                  <Box color="green">
                    2. Выбери желаемую цель.
                  </Box>
                  <Box color="yellow">
                    3. Цели будут появляться на границе радарного пинга.
                    Сделай 3 радарных пинга, где все три круга будут
                    пересекаться.
                  </Box>
                  <Box color="purple">
                    Чем дальше ты от цели, тем лучше будет результат
                    Двигающиеся цели могут создать трудности.
                  </Box>
                </Section>
              } />
          </Box>
  ...
  return (
    <svg
      ...
      <text x="-230" y="3" fill="white" fontSize="26">
        Выбери цель из выпадающего меню.
      </text>
    </svg>
  );
};
...
const LocatorViewWindow = (props, context) => {
  ...
  const [
    zoomScale,
    setZoomScale,
  ] = useLocalState(context, 'zoomScale', 1/8);
