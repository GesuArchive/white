            ...
            <Stack fill>
              <Stack.Item>
                <Section
                  ...
                  title="Категории"
                  buttons={
                    <Button content="Синхр." onClick={() => act('sync_rnd')} />
                  }>
                  <PartSets />
                </Section>
              </Stack.Item>
              <Stack.Item position="relative" grow={1}>
                <Box fillPositionedParent overflowY="scroll">
                  <PartLists
          ...
          <Stack align="center">
            ...
            <Stack.Item>
              <Button
                ...
                tooltip={
                  'Время сборки: ' + part.printTime + 'с. ' + (part.desc || '')
                }
    ...
    return (
      <ProgressBar minValue={0} maxValue={1} value={1} color="average">
        <Stack>
          ...
          <Stack.Item>Выход закрыт...</Stack.Item>
        </Stack>
      </ProgressBar>
    );
  }
