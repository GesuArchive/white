    ...
    <Section
      ...
      {!has_nanites ? (
        ...
        <>
          ...
          <Section title="Программы" level={2}>
                  ...
                  <Section>
                    ...
                    {scan_level >= 2 && (
                      <Grid>
                        {!!program.can_trigger && (
                          <Grid.Column>
                            <Section title="Триггеры" level={2}>
                              <LabeledList>
                                ...
                                {!!program.timer_trigger && (
                                  <LabeledList.Item label="Повторитель">
                    ...
                    {scan_level >= 3 && !!program.has_extra_settings && (
                      <Section title="Дополнительно" level={2}>
                        <LabeledList>
