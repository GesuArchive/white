...
/atom/movable/screen/plane_master/rendering_plate/game_world/show_to(mob/mymob)
	...
	add_filter("black", 1, layering_filter(color = "#000000"))
	add_filter("red", 2, layering_filter(color = "#FF000001", x = 1, y = 1))
	add_filter("green", 3, layering_filter(color = "#00FF0001", x = 0, y = 0))
	add_filter("blue", 4, layering_filter(color = "#0000FF01", x = -1, y = -1))
