...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_HACKER" = TRAIT_HACKER,
		"TRAIT_DREAMER" = TRAIT_DREAMER,
		"TRAIT_KARTAVII" = TRAIT_KARTAVII,
		"TRAIT_ASIAT" = TRAIT_ASIAT,
		"TRAIT_NEGRO" = TRAIT_NEGRO,
		"TRAIT_HYPERSPACE_IMMUNE" = TRAIT_HYPERSPACE_IMMUNE,
		...
		"TRAIT_LIGHT_POOER" = TRAIT_LIGHT_POOER,
		...
		"TRAIT_LOOKING_INTO_DISTANCE" = TRAIT_LOOKING_INTO_DISTANCE,
