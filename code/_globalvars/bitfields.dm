...
DEFINE_BITFIELD(check_flags, list(
	"CHECK_IF_HANDS BLOCKED" = AB_CHECK_HANDS_BLOCKED,
	"CHECK_IF_IMMOBILIZED" = AB_CHECK_IMMOBILE,
	"CHECK_IF_LYING DOWN" = AB_CHECK_LYING,
	"CHECK_IF_CONSCIOUS" = AB_CHECK_CONSCIOUS,
	"CHECK_IF_INCAPACITATED" = AB_CHECK_INCAPACITATED
))
