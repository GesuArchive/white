...
GLOBAL_LIST_INIT_TYPED(cell_line_tables, /list, list(
	CELL_LINE_TABLE_SLUDGE = list(/datum/micro_organism/cell_line/sholean_grapes = 2, /datum/micro_organism/cell_line/blobbernaut = 1, /datum/micro_organism/cell_line/slime = 2, /datum/micro_organism/cell_line/cow = 1, /datum/micro_organism/cell_line/mouse = 1, /datum/micro_organism/cell_line/chicken = 1, /datum/micro_organism/cell_line/pig = 1, /datum/micro_organism/cell_line/cockroach = 2),
	...
	"cell_line_shvainokaras_table" = list(/datum/micro_organism/cell_line/shvainokaras = 1), //параша не хочет работать с человеческими дефайнами почему-то
	"cell_line_pig_table" = list(/datum/micro_organism/cell_line/pig = 99, /datum/micro_organism/cell_line/shvainokaras = 1),
