...
GLOBAL_LIST_EMPTY(yohei_beacons)
...
GLOBAL_LIST_INIT(megafauna_spawn_list, list(
	/mob/living/simple_animal/hostile/megafauna/bubblegum = 12,
	/mob/living/simple_animal/hostile/megafauna/colossus = 4,
	/mob/living/simple_animal/hostile/megafauna/dragon = 8,
	/mob/living/simple_animal/hostile/megafauna/wendigo = 1,
	/mob/living/simple_animal/hostile/megafauna/demonic_frost_miner = 1,
	/mob/living/simple_animal/hostile/megafauna/sans = 1,
))
