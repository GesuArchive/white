...
/datum/game_mode/traitor/bros/generate_report()
	return "Наступает сезон набора в Синдикат. Будьте внимательны к потенциальным злоумышленникам Синдиката, но также остерегайтесь недовольных сотрудников, пытающихся сбежать. В отличие от NanoTrasen, Синдикат гордится своей командной работой и набирает только те пары, которые разделяют братское доверие."
*/
