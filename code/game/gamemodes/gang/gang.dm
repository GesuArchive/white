/datum/game_mode/gang
	...
	restricted_jobs = list("Cyborg", "AI", "Prisoner", "Security Officer", "Russian Officer", "Hacker", "Veteran", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Field Medic", "Exploration Crew")//N O
	protected_jobs = list()
