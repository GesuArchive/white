/datum/game_mode/gang
	...
	restricted_jobs = list(JOB_CYBORG, JOB_AI, JOB_PRISONER, JOB_SECURITY_OFFICER, JOB_RUSSIAN_OFFICER, JOB_HACKER, JOB_VETERAN, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_HEAD_OF_PERSONNEL, JOB_FIELD_MEDIC, JOB_SPECIALIST, JOB_RANGER)//N O
