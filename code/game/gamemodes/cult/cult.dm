...
/datum/game_mode/cult
	...
	restricted_jobs = list(JOB_PRISONER, JOB_CHAPLAIN,JOB_AI, JOB_CYBORG, JOB_RUSSIAN_OFFICER, JOB_TRADER, JOB_HACKER,JOB_VETERAN, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_HEAD_OF_PERSONNEL, JOB_FIELD_MEDIC, JOB_SPECIALIST)
	protected_jobs = list(JOB_RANGER, JOB_SHAFT_MINER, JOB_HUNTER, JOB_FREELANCER, JOB_INTERN)
	required_players = 29
	required_enemies = 4
