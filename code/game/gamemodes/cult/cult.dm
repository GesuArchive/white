...
/datum/game_mode/cult
	...
	restricted_jobs = list("Prisoner", "Chaplain","AI", "Cyborg", "Russian Officer", "Hacker","Veteran", "International Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel")
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
