...
/datum/game_mode
	...
	var/list/required_jobs = list(list("Captain" = 1)) // alternative required job groups eg list(list(cap=1),list(hos=1,sec=2)) translates to one captain OR one hos and two secmans
