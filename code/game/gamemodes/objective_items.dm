...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list(JOB_CHIEF_ENGINEER,JOB_RESEARCH_DIRECTOR,JOB_STATION_ENGINEER,JOB_SCIENTIST,JOB_ATMOSPHERIC_TECHNICIAN,JOB_MECHANIC)
...
/datum/objective_item/steal/blackbox
	...
	difficulty = 10
	excludefromjob = list(JOB_CHIEF_ENGINEER,JOB_STATION_ENGINEER,JOB_ATMOSPHERIC_TECHNICIAN,JOB_MECHANIC)
