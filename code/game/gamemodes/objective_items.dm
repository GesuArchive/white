...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list("Chief Engineer","Research Director","Station Engineer","Scientist","Atmospheric Technician","Mechanic")
...
/datum/objective_item/steal/blackbox
	...
	difficulty = 10
	excludefromjob = list("Chief Engineer","Station Engineer","Atmospheric Technician","Mechanic")
