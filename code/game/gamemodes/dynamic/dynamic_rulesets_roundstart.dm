...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list("Prisoner", "Russian Officer", "Trader", "Hacker","Veteran", "International Officer", "Warden", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/traitorbro
	...
	protected_roles = list("Russian Officer", "Hacker","Veteran", "International Officer", "Warden", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Trader", "Russian Officer", "Hacker","Veteran", "International Officer", "Warden", "Detective", "Head of Security", "Captain", "Chaplain", "Head of Personnel")
	required_candidates = 2
	weight = 3
	cost = 35
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Trader", "Russian Officer", "Hacker","Veteran", "International Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director")
...
/datum/dynamic_ruleset/roundstart/revs/rule_process()
	if(check_rev_victory())
		...
		priority_announce("It appears the mutiny has been quelled. Please return yourself and your incapacitated colleagues to work. \
			We have remotely blacklisted the head revolutionaries in your medical records to prevent accidental revival.", null, 'sound/ai/announcer/alert.ogg', null, "Central Command Loyalty Monitoring Division")
		return RULESET_STOP_PROCESSING
