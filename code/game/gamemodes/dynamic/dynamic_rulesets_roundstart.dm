...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list("Prisoner", "Russian Officer", "Kazakhstan Officer", "International Officer", "Warden", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/traitorbro
	...
	protected_roles = list("Russian Officer", "Kazakhstan Officer", "International Officer", "Warden", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Russian Officer", "Kazakhstan Officer", "International Officer", "Warden", "Detective", "Head of Security", "Captain", "Chaplain", "Head of Personnel")
	required_candidates = 2
	weight = 3
	cost = 35
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Russian Officer", "Kazakhstan Officer", "International Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director")
