...
/datum/game_mode/devil/generate_report()
	return "Поблизости были замечены адские существа, предлагающие великие дары в обмен на души. NanoTrasen считает это кражей, поскольку все трудовые договоры содержат залоговое право на душу сотрудника. \
