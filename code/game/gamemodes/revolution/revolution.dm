...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Prisoner", "Russian Officer", "Trader", "Hacker","Veteran", "International Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
