...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Prisoner", "Russian Officer", "Trader", "Hacker", "Veteran", "Security Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Field Medic")
...
/datum/game_mode/revolution/generate_report()
	...
	вы и ваши руководители полностью уполномочены казнить их, используя смертоносное оружие - позже они будут клонированы и допрошены в Центральном Командовании."
