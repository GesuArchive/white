...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Russian Officer", "Kazakhstan Officer", "International Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
