...
/datum/game_mode/traitor/changeling/generate_report()
	return "Синдикат начал некоторые экспериментальные исследования по изменению облика гуманоидов. Ходят слухи, что эта технология будет испытана в полевых условиях на станции NanoTrasen \
