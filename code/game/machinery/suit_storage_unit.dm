...
/obj/machinery/suit_storage_unit/captain/old
...
/obj/machinery/suit_storage_unit/engine/old
...
/obj/machinery/suit_storage_unit/atmos/old
...
/obj/machinery/suit_storage_unit/ce/old
...
/obj/machinery/suit_storage_unit/security/old
...
/obj/machinery/suit_storage_unit/hos/old
	suit_type = /obj/item/clothing/suit/space/hardsuit/security/hos
	mask_type = /obj/item/clothing/mask/gas/sechailer
	storage_type = /obj/item/tank/internals/tactical

/obj/machinery/suit_storage_unit/hos
	mask_type = /obj/item/clothing/suit/space/hardsuit/security/hos
	storage_type = /obj/item/tank/internals/tactical
...
/obj/machinery/suit_storage_unit/mining/eva/old
...
/obj/machinery/suit_storage_unit/cmo/old
...
/obj/machinery/suit_storage_unit/rd/old
...
/obj/machinery/suit_storage_unit/syndicate/old
		...
		if ("disinfect")
			if (occupant && safeties)
				...
				if (occupant)
					...
					to_chat(mob_occupant, "<span class='userdanger'>[capitalize(src.name)] confines grow warm, then hot, then scorching. You're being burned [!mob_occupant.stat ? "alive" : "away"]!</span>")
				cook()
		if ("lock", "unlock")
			if (!state_open)
				locked = !locked
...
/obj/machinery/suit_storage_unit/MouseDrop_T(atom/A, mob/living/user)
	...
	if(do_mob(user, target, 30))
		if(occupant || helmet || suit || storage)
			return
		if(target == user)
			user.visible_message("<span class='warning'>[user] slips into [src] and closes the door behind [user.ru_na()]!</span>" , "<span class=notice'>You slip into [src] cramped space and shut its door.</span>")
		else
...
/obj/machinery/suit_storage_unit/proc/cook()
	...
	if(uv_cycles)
		...
		if(uv_super)
			...
			if(!mob_occupant)
				visible_message("<span class='notice'>[capitalize(src.name)] door slides open. The glowing yellow lights dim to a gentle green.</span>")
			else
				visible_message("<span class='warning'>[capitalize(src.name)] door slides open, barraging you with the nauseating smell of charred flesh.</span>")
