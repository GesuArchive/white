...
/obj/machinery/suit_storage_unit/proc/cook()
	...
	if(uv_cycles)
		...
		locked = FALSE
		if(uv_super)
			visible_message("<span class='warning'>[capitalize(src.name)] door creaks open with a loud whining noise. A cloud of foul black smoke escapes from its chamber.</span>")
