...
/obj/item/gavelhammer
	...
	attack_verb_continuous = list("колотит", "избивает", "судит", "бьёт")
	attack_verb_simple = list("колотит", "избивает", "судит", "бьёт")
	resistance_flags = FLAMMABLE

/obj/item/gavelhammer/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] has sentenced [user.ru_na()]self to death with [src]! It looks like [user.p_theyre()] trying to commit suicide!</span>")
