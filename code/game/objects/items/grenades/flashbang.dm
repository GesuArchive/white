...
/obj/item/grenade/flashbang/proc/bang(turf/T , mob/living/M)
	if(M.stat == DEAD)	//They're dead!
		return
	M.show_message("<span class='warning'>БАМ!</span>", MSG_AUDIBLE)
...
/obj/item/grenade/stingbang/prime(mob/living/lanced_by)
	if(iscarbon(loc))
		...
		if(B)
			...
			C.visible_message("<b><span class='danger'>[capitalize(src.name)] goes off in [C]'s hand, blowing [C.p_their()] [B.name] to bloody shreds!</span></b>", "<span class='userdanger'>[capitalize(src.name)] goes off in your hand, blowing your [B.name] to bloody shreds!</span>")
			B.dismember()
