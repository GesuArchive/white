...
/obj/structure/checkoutmachine/examine(mob/living/user)
	. = ..()
	. += "<hr><span class='info'>It's integrated integrity meter reads: <b>HEALTH: [obj_integrity]</b>.</span>"
...
/obj/effect/dumpeet_target/Initialize(mapload, user)
	...
	deadchat_broadcast("Протокол CRAB-17 был активирован. Рынок спейскоина был запущен на станции!", turf_target = get_turf(src), message_type=DEADCHAT_ANNOUNCEMENT)
