...
/datum/dimension_theme/icebox
	...
	replace_floors = list(/turf/open/floor/grass/snow/actually_safe = 10, /turf/open/floor/fakeice/slippery = 1)
...
/datum/dimension_theme/lavaland
	...
	replace_floors = list(/turf/open/floor/grass/fakebasalt = 5, /turf/open/floor/fakepit = 1)
	replace_walls = /turf/closed/wall/mineral/cult
	replace_objs = list(\
		/obj/machinery/door/airlock = list(/obj/machinery/door/airlock/external/glass = 1))
...
/datum/dimension_theme/space
	...
	replace_walls = /turf/closed/wall/mineral
	replace_objs = list(/obj/machinery/door/airlock = list(/obj/machinery/door/airlock/external/glass = 1))
