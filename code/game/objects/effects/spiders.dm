...
/obj/structure/spider/stickyweb/CanAllowThrough(atom/movable/mover, turf/target)
	...
	if(istype(mover, /mob/living/simple_animal/hostile/poison/giant_spider))
		...
		if(istype(mover.pulledby, /mob/living/simple_animal/hostile/poison/giant_spider))
			return TRUE
		if(prob(50))
			to_chat(mover, "<span class='danger'>You get stuck in <b>[src.name]</b> for a moment.</span>")
			return FALSE
...
/obj/structure/spider/spiderling/process()
	...
	//=================
		...
		if(nearby.len)
			...
			if(prob(40))
				src.visible_message("<span class='notice'><b>[src.name]</b> skitters[pick(" away"," around","")].</span>")
	else if(prob(10))
		//ventcrawl!
...
/obj/structure/spider/cocoon/container_resist_act(mob/living/user)
	...
	visible_message("<span class='notice'>You see something struggling and writhing in <b>[src.name]</b>!</span>")
...
/obj/structure/spider/cocoon/Destroy()
	...
	src.visible_message("<span class='warning'><b>[src.name]</b> splits open.</span>")
