...
/obj/structure/spider/stickyweb/CanAllowThrough(atom/movable/mover, border_dir)
	...
	if(istype(mover, /mob/living/simple_animal/hostile/poison/giant_spider))
		...
		if(istype(mover.pulledby, /mob/living/simple_animal/hostile/poison/giant_spider))
			return TRUE
		if(prob(50))
			to_chat(mover, span_danger("You get stuck in <b>[src.name]</b> for a moment."))
			return FALSE
...
/obj/structure/spider/spiderling/process()
	...
	//=================
		...
		if(nearby.len)
			...
			if(prob(40))
				src.visible_message(span_notice("<b>[src.name]</b> skitters[pick(" away"," around","")]."))
	else if(prob(10))
		//ventcrawl!
...
/obj/structure/spider/cocoon/container_resist_act(mob/living/user)
	...
	visible_message(span_notice("You see something struggling and writhing in <b>[src.name]</b>!"))
...
/obj/structure/spider/cocoon/Destroy()
	...
	src.visible_message(span_warning("<b>[src.name]</b> splits open."))
