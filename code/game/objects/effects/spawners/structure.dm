...
/obj/effect/spawner/structure/window/hollow
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window, /obj/structure/window/spawner/north, /obj/structure/window/spawner/east, /obj/structure/window/spawner/west, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/hollow/end/Initialize()
	switch(dir)
		if(NORTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/spawner/north, /obj/structure/window/spawner/east, /obj/structure/window/spawner/west, /obj/machinery/door/firedoor/window)
		if(EAST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window, /obj/structure/window/spawner/north, /obj/structure/window/spawner/east, /obj/machinery/door/firedoor/window)
		if(SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window, /obj/structure/window/spawner/east, /obj/structure/window/spawner/west, /obj/machinery/door/firedoor/window)
		if(WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window, /obj/structure/window/spawner/north, /obj/structure/window/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/hollow/middle/Initialize()
	switch(dir)
		if(NORTH,SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window, /obj/structure/window/spawner/north, /obj/machinery/door/firedoor/window)
		if(EAST,WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/spawner/east, /obj/structure/window/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/hollow/reinforced
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced, /obj/structure/window/reinforced/spawner/north, /obj/structure/window/reinforced/spawner/east, /obj/structure/window/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/hollow/reinforced/end/Initialize()
	switch(dir)
		if(NORTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced/spawner/north, /obj/structure/window/reinforced/spawner/east, /obj/structure/window/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
		if(EAST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced, /obj/structure/window/reinforced/spawner/north, /obj/structure/window/reinforced/spawner/east, /obj/machinery/door/firedoor/window)
		if(SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced, /obj/structure/window/reinforced/spawner/east, /obj/structure/window/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
		if(WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced, /obj/structure/window/reinforced/spawner/north, /obj/structure/window/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/hollow/reinforced/middle/Initialize()
	switch(dir)
		if(NORTH,SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced, /obj/structure/window/reinforced/spawner/north, /obj/machinery/door/firedoor/window)
		if(EAST,WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced/spawner/east, /obj/structure/window/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/shuttle
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/shuttle, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/plasma/reinforced/plastitanium
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma/reinforced/plastitanium, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/ice
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced/fulltile/ice, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/survival_pod
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/reinforced/survival_pod, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/hollow/plasma
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma, /obj/structure/window/plasma/spawner/north, /obj/structure/window/plasma/spawner/east, /obj/structure/window/plasma/spawner/west, /obj/machinery/door/firedoor/window)
...
/obj/effect/spawner/structure/window/hollow/plasma/end/Initialize()
	switch(dir)
		if(NORTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma/spawner/north, /obj/structure/window/plasma/spawner/east, /obj/structure/window/plasma/spawner/west, /obj/machinery/door/firedoor/window)
		if(EAST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma, /obj/structure/window/plasma/spawner/north, /obj/structure/window/plasma/spawner/east, /obj/machinery/door/firedoor/window)
		if(SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma, /obj/structure/window/plasma/spawner/east, /obj/structure/window/plasma/spawner/west, /obj/machinery/door/firedoor/window)
		if(WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma, /obj/structure/window/plasma/spawner/north, /obj/structure/window/plasma/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/hollow/plasma/middle/Initialize()
	switch(dir)
		if(NORTH,SOUTH)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma, /obj/structure/window/plasma/spawner/north, /obj/machinery/door/firedoor/window)
		if(EAST,WEST)
			spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma/spawner/east, /obj/structure/window/plasma/spawner/west, /obj/machinery/door/firedoor/window)
	. = ..()
...
/obj/effect/spawner/structure/window/hollow/plasma/reinforced
	...
	spawn_list = list(/obj/structure/grille, /obj/structure/window/plasma/reinforced, /obj/structure/window/plasma/reinforced/spawner/north, /obj/structure/window/plasma/reinforced/spawner/east, /obj/structure/window/plasma/reinforced/spawner/west, /obj/machinery/door/firedoor/window)
