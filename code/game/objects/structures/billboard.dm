/obj/structure/billboard
	name = "пустой рекламный щит"
	desc = "Здесь может быть ваша реклама."
...
/obj/structure/billboard/nanotrasen/defaced
	name = "рекламный щит обезличивания NanoTrasen"
...
/obj/structure/billboard/azik
	name = "рекламный щит Azik Interstellar"
...
/obj/structure/billboard/cvr
	name = "Charlemagne von Rheinland billboard"
...
/obj/structure/billboard/starway
	name = "Starway Transit billboard"
...
/obj/structure/billboard/lizards_gas
	name = "The Lizard's Gas billboard"
...
/obj/structure/billboard/smoothies
	name = "Spinward Smoothies billboard"
