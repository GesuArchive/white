...
/obj/item/slimecross/burning/orange/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] boils over with a caustic gas!"))
...
/obj/item/slimecross/burning/purple/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] fills with a bubbling liquid!"))
...
/obj/item/slimecross/burning/blue/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] flash-freezes the area!"))
...
/obj/item/slimecross/burning/metal/do_effect(mob/user)
	...
	user.visible_message(span_danger("[capitalize(src.name)] pulses violently, and shatters the walls around it!"))
	..()
...
/obj/item/slimecross/burning/yellow/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] explodes into an electrical field!"))
...
/obj/item/slimecross/burning/darkpurple/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] sublimates into a cloud of plasma!"))
...
/obj/item/slimecross/burning/darkblue/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] releases a burst of chilling smoke!"))
	var/datum/reagents/tmp_holder = new/datum/reagents(100)
...
/obj/item/slimecross/burning/silver/do_effect(mob/user)
	...
	user.visible_message(span_danger("[capitalize(src.name)] produces a few pieces of food!"))
	..()
...
/obj/item/slimecross/burning/bluespace/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] sparks, and lets off a shockwave of bluespace energy!"))
...
/obj/item/slimecross/burning/sepia/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] shapes itself into a camera!"))
...
/obj/item/slimecross/burning/cerulean/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] produces a potion!"))
...
/obj/item/slimecross/burning/pyrite/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] releases a colorful wave of energy, which shatters the lights!"))
...
/obj/item/slimecross/burning/red/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] pulses a hazy red aura for a moment, which wraps around [user]!"))
...
/obj/item/slimecross/burning/green/do_effect(mob/user)
	...
	if(!L.put_in_hands(blade))
		qdel(blade)
		user.visible_message(span_warning("[capitalize(src.name)] melts onto [user] arm, boiling the flesh horribly!"))
	else
		user.visible_message(span_danger("[capitalize(src.name)] sublimates the flesh around [user] arm, transforming the bone into a gruesome blade!"))
	user.emote("agony")
...
/obj/item/slimecross/burning/pink/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] shrinks into a small, gel-filled pellet!"))
...
/obj/item/slimecross/burning/gold/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] shudders violently, and summons an army for [user]!"))
...
/obj/item/slimecross/burning/lightpink/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] lets off a hypnotizing pink glow!"))
...
/obj/item/slimecross/burning/adamantine/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] crystallizes into a large shield!"))
...
/obj/item/slimecross/burning/rainbow/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] flattens into a glowing rainbow blade."))
