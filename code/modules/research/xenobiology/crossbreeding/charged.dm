...
/obj/item/slimecross/charged/grey/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] distills into a potion!</span>")
	..()
...
/obj/item/slimecross/charged/purple/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] sparks, and floods with a regenerative solution!</span>")
	..()
...
/obj/item/slimecross/charged/metal/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] grows into a plethora of metals!</span>")
	..()
...
/obj/item/slimecross/charged/yellow/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] sparks violently, and swells with electric power!</span>")
	..()
...
/obj/item/slimecross/charged/darkpurple/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] produces a large amount of plasma!</span>")
	..()
...
/obj/item/slimecross/charged/silver/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] produces a party's worth of cake and drinks!</span>")
	..()
...
/obj/item/slimecross/charged/bluespace/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] produces several sheets of polycrystal!</span>")
	..()
...
/obj/item/slimecross/charged/sepia/do_effect(mob/user)
	...
	user.visible_message("<span class='notice'>[capitalize(src.name)] flickers in a strange, ethereal manner, and produces a camera!</span>")
	..()
...
/obj/item/slimecross/charged/pyrite/do_effect(mob/user)
	...
	user.visible_message("<span class='warning'>[capitalize(src.name)] solidifies with a horrifying banana stench!</span>")
	..()
...
/obj/item/slimecross/charged/gold/do_effect(mob/user)
	user.visible_message("<span class='warning'>[capitalize(src.name)] starts shuddering violently!</span>")
...
/obj/item/slimecross/charged/gold/process()
	visible_message("<span class='warning'>[capitalize(src.name)] lets off a spark, and produces a living creature!</span>")
	...
	if(spawned >= max_spawn)
		visible_message("<span class='warning'>[capitalize(src.name)] collapses into a puddle of goo.</span>")
		qdel(src)
...
/obj/item/slimecross/charged/oil/do_effect(mob/user)
	user.visible_message("<span class='danger'>[capitalize(src.name)] begins to shake with rapidly increasing force!</span>")
...
/obj/item/slimecross/charged/adamantine/do_effect(mob/user)
	user.visible_message("<span class='notice'>[capitalize(src.name)] produces a fully formed golem shell!</span>")
...
/obj/item/slimecross/charged/rainbow/do_effect(mob/user)
	user.visible_message("<span class='warning'>[capitalize(src.name)] swells and splits into three new slimes!</span>")
	for(var/i in 1 to 3)
