...
/obj/item/slimecross/charged/grey/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] distills into a potion!"))
	..()
...
/obj/item/slimecross/charged/purple/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] sparks, and floods with a regenerative solution!"))
	..()
...
/obj/item/slimecross/charged/metal/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] grows into a plethora of metals!"))
	..()
...
/obj/item/slimecross/charged/yellow/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] sparks violently, and swells with electric power!"))
	..()
...
/obj/item/slimecross/charged/darkpurple/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] produces a large amount of plasma!"))
	..()
...
/obj/item/slimecross/charged/silver/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] produces a party's worth of cake and drinks!"))
	..()
...
/obj/item/slimecross/charged/bluespace/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] produces several sheets of polycrystal!"))
	..()
...
/obj/item/slimecross/charged/sepia/do_effect(mob/user)
	...
	user.visible_message(span_notice("[capitalize(src.name)] flickers in a strange, ethereal manner, and produces a camera!"))
	..()
...
/obj/item/slimecross/charged/pyrite/do_effect(mob/user)
	...
	user.visible_message(span_warning("[capitalize(src.name)] solidifies with a horrifying banana stench!"))
	..()
...
/obj/item/slimecross/charged/green/do_effect(mob/user)
	...
	H.visible_message(span_warning("[H] suddenly shifts form as [src] dissolves into [H.ru_ego()] skin!"))
	..()
...
/obj/item/slimecross/charged/gold/do_effect(mob/user)
	user.visible_message(span_warning("[capitalize(src.name)] starts shuddering violently!"))
...
/obj/item/slimecross/charged/gold/process()
	visible_message(span_warning("[capitalize(src.name)] lets off a spark, and produces a living creature!"))
	...
	if(spawned >= max_spawn)
		visible_message(span_warning("[capitalize(src.name)] collapses into a puddle of goo."))
		qdel(src)
...
/obj/item/slimecross/charged/oil/do_effect(mob/user)
	user.visible_message(span_danger("[capitalize(src.name)] begins to shake with rapidly increasing force!"))
...
/obj/item/slimecross/charged/adamantine/do_effect(mob/user)
	user.visible_message(span_notice("[capitalize(src.name)] produces a fully formed golem shell!"))
...
/obj/item/slimecross/charged/rainbow/do_effect(mob/user)
	user.visible_message(span_warning("[capitalize(src.name)] swells and splits into three new slimes!"))
	for(var/i in 1 to 3)
