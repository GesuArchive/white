...
/obj/effect/warped_rune/proc/on_entered(atom/newloc, atom/movable/AM, oldloc)
	SIGNAL_HANDLER
...
/obj/effect/warped_rune/cyanspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(isliving(AM))
...
/obj/effect/warped_rune/darkcyanspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(isliving(AM))
		var/mob/living/L = AM
...
/obj/effect/warped_rune/yellowspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
...
/obj/effect/warped_rune/silverspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(iscarbon(AM))
...
/obj/effect/warped_rune/sepiaspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
...
/obj/effect/warped_rune/pyritespace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(isliving(AM))
...
/obj/effect/warped_rune/redspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(ishuman(AM))
...
/obj/effect/warped_rune/greenspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(ishuman(AM))
		randomize_human(AM)
		activated_on_step = TRUE
	. = ..()
...
/obj/effect/warped_rune/pinkspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
...
/obj/effect/warped_rune/oilspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(iscarbon(AM))
		var/mob/living/carbon/C = AM
		var/amt = rand(4,12)
...
/obj/effect/warped_rune/blackspace/do_effect(mob/user)
	for(var/mob/living/carbon/human/host in rune_turf)
		...
		var/list/candidates = poll_candidates_for_mob("Do you want to replace the soul of [host.name]?", ROLE_SENTIENCE, null, 50, host, POLL_IGNORE_SHADE)//todo: fix desc
...
/obj/effect/warped_rune/lightpinkspace/on_entered(atom/newloc, atom/movable/AM, oldloc)
	if(iscarbon(AM))
		var/mob/living/carbon/C = AM
