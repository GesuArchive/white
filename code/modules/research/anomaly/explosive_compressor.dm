...
/obj/machinery/research/explosive_compressor/examine(mob/user)
	...
	. += "<span class='notice'>\nClick with an empty hand to gather information about the required radius of an inserted core. Insert a ready TTV to start the implosion process if a core is inserted.</span>"
