...
/datum/techweb_node/cyber_organs
	...
	prereq_ids = list("biotech")
	design_ids = list("cybernetic_ears", "cybernetic_heart_tier2", "cybernetic_liver_tier2", "cybernetic_lungs_tier2", "cybernetic_stomach_tier2", "cybernetic_kidneys_tier2")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1000)
...
/datum/techweb_node/cyber_organs_upgraded
	...
	design_ids = list("cybernetic_ears_u", "cybernetic_heart_tier3", "cybernetic_liver_tier3", "cybernetic_lungs_tier3", "cybernetic_stomach_tier3", "cybernetic_kidneys_tier3")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1500)
