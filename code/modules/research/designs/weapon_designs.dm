...
/datum/design/energy_smg
	...
	id = "energy_smg"
	build_type = PROTOLATHE
	materials = list(/datum/material/titanium = 10000, /datum/material/glass = 2000, /datum/material/diamond = 2000, /datum/material/iron = 2000)
	build_path = /obj/item/gun/ballistic/energy_smg/nopin
	category = list("Weapons")
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY | DEPARTMENTAL_FLAG_SCIENCE//убрать флаг –нƒ если чрезмерно охуеют
