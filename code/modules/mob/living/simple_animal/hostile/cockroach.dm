...
/mob/living/simple_animal/hostile/cockroach/hauberoach
	...
	obj_damage = 20
	gold_core_spawnable = HOSTILE_SPAWN
	attack_sound = 'sound/weapons/stab1.ogg'
...
/mob/living/simple_animal/hostile/cockroach/hauberoach/make_squashable()
	AddComponent(/datum/component/squashable, squash_chance = 100, squash_damage = 1, squash_callback = TYPE_PROC_REF(/mob/living/simple_animal/hostile/cockroach/hauberoach, on_squish))
