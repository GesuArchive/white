...
/mob/living/simple_animal/hostile/netherworld/migo/Initialize()
	. = ..()
	migo_sounds = list(
		'sound/ai/en/default/aimalf.ogg',
		'sound/ai/en/default/outbreak5.ogg',
		'sound/ai/en/default/outbreak7.ogg',
		'sound/ai/en/default/poweroff.ogg',
		'sound/ai/en/default/radiation.ogg',
		'sound/ai/en/default/shuttlecalled.ogg',
		'sound/ai/en/default/shuttledock.ogg',
		'sound/ai/en/default/shuttlerecalled.ogg',
