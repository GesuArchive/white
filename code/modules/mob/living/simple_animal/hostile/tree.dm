...
/mob/living/simple_animal/hostile/tree/AttackingTarget()
	...
	if(iscarbon(target))
		...
		if(prob(15))
			C.Paralyze(60)
			C.visible_message("<span class='danger'><b>[src.name]</b> knocks down \the [C]!</span>", \
...
/mob/living/simple_animal/hostile/tree/festivus/attack_hand(mob/living/carbon/human/M)
	. = ..()
	if(M.a_intent == "help")
		visible_message("<span class='warning'>[capitalize(src.name)] crackles with static electricity!</span>")
