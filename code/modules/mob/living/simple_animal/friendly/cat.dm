...
/mob/living/simple_animal/pet/cat
	...
	butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab = 2, /obj/item/stack/sheet/animalhide/cat = 1, /obj/item/organ/ears/cat = 1, /obj/item/organ/tail/cat = 1)
