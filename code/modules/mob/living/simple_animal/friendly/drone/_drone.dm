...
/mob/living/simple_animal/drone
	...
	var/flavortext = \
	"\n<big><span class='warning'>Не нарушайте правила для дронов указанные ниже.</span></big>\n"+\
	"<span class='notice'>Будучи дроном ты ДОЛЖЕН И ТОЛЬКО ДОЛЖЕН производить ремонт станции. Любое вмешательство дрона в раунд карается перманентным баном.</span>\n"+\
	"<span class='notice'>Действия, которые запрещены:</span>\n"+\
	...
	"<span class='notice'> - Взаимодействие с НЕ живыми существами (перенос трупов, раздевание трупов и прочее).</span>\n"+\
	...
	span_warning("<u>Даже если ты умудрился заспавниться без правил для силиконов, ты должен подчиняться правилам, которые указаны выше.</u>")
