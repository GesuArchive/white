...
/mob/living/silicon/proc/deadchat_lawchange()
	...
	deadchat_broadcast("'s <b>laws were changed.</b> <a href='?src=[REF(src)]&dead=1&printlawtext=[url_encode(lawtext)]'>View</a>", "<span class='name'>[capitalize(src.name)]</span>", follow_target=src, message_type=DEADCHAT_LAWCHANGE)
