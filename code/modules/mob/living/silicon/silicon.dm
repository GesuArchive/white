/mob/living/silicon
	...
	hud_possible = list(ANTAG_HUD, DIAG_STAT_HUD, DIAG_HUD, DIAG_TRACK_HUD,HACKER_HUD)
...
/mob/living/silicon/try_inject(mob/user, target_zone, injection_flags)
	...
	if(!. && (injection_flags & INJECT_TRY_SHOW_ERROR_MESSAGE))
		to_chat(user, span_alert("[ru_ego(TRUE)] outer shell is too tough."))
...
/mob/living/silicon/proc/checklaws() //Gives you a link-driven interface for deciding what laws the statelaws() proc will share with the crew. --NeoFite
	...
	var/list = "<meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><b>Which laws do you want to include when stating them for the crew?</b><br><br>"
