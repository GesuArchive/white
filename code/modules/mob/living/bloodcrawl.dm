...
/mob/living/proc/bloodpool_sink(obj/effect/decal/cleanable/B)
	...
	visible_message(span_warning("[capitalize(src.name)] sinks into the pool of blood!"))
...
/mob/living/proc/phasein(obj/effect/decal/cleanable/B)
	...
	visible_message(span_boldwarning("[capitalize(src.name)] rises out of the pool of blood!"))
	exit_blood_effect(B)
	if(iscarbon(src))
		var/mob/living/carbon/C = src
