...
//this is very slightly better than it was because you can use it more places. still can't do \his[src] though.
	...
	if(true_info)
		if(!client?.holder)
			...
			SEND_SOUND(user, sound('sound/ai/ru/hacker//scanned.ogg'))
			var/is_weapon = FALSE
			...
			if(is_weapon)
				spawn(15)
					SEND_SOUND(user, sound('sound/ai/ru/hacker//weapon.ogg'))
