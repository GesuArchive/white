	...
	if(href_list["hud"])
		...
		if(href_list["hud"] == "s")
			...
			if(href_list["add_comment"])
				...
				while(R.fields[text("com_[]", counter)])
					counter++
				R.fields[text("com_[]", counter)] = text("Сделано [] в [] []/[]<BR>[]", allowed_access, station_time_timestamp(), time2text(world.realtime, "DD/MM"), CURRENT_STATION_YEAR, t1)
...
/mob/living/carbon/human/species/ipc/military
	race = /datum/species/ipc/military
