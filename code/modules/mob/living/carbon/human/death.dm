...
/mob/living/carbon/human/death(gibbed)
	...
	if(mind && !mind.antag_datums && lastattacker && lastattacker != real_name)
		...
		tgui_alert_async(src, "Тебя кто-то убил. Персонаж получил травму связанную с этим событием не дающую ему вспомнить своего убийцу. Возможно психолог поможет вспомнить.", "ПТСР", list("Понимаю"))
