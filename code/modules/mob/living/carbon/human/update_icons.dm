...
/mob/living/carbon/human/update_inv_w_uniform()
	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		if(!uniform_overlay)
			uniform_overlay = U.build_worn_icon(default_layer = UNIFORM_LAYER, default_icon_file = 'icons/mob/clothing/uniform.dmi', isinhands = FALSE, override_state = target_overlay)
