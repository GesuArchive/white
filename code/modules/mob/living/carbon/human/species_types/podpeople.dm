	...
	switch(P.type)
		if(/obj/projectile/energy/floramut)
			if(prob(15))
				...
				H.Paralyze(100)
				H.visible_message("<span class='warning'>[H] writhes in pain as [H.ru_ego()] vacuoles boil.</span>", "<span class='userdanger'>You writhe in pain as your vacuoles boil!</span>", "<span class='hear'>You hear the crunching of leaves.</span>")
				if(prob(80))
