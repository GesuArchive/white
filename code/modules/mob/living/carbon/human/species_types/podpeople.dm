	...
	switch(P.type)
		if(/obj/projectile/energy/floramut)
			if(prob(15))
				...
				H.Paralyze(100)
				H.visible_message(span_warning("[H] writhes in pain as [H.ru_ego()] vacuoles boil.") , span_userdanger("You writhe in pain as your vacuoles boil!") , span_hear("You hear the crunching of leaves."))
				if(prob(80))
