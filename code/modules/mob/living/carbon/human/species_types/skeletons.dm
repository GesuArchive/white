/datum/species/skeleton
	...
	species_traits = list(NOBLOOD, HAS_BONE, NOEYESPRITES, NOGUTS, NOKIDNEYS)
	...
	TRAIT_PIERCEIMMUNE,TRAIT_NOHUNGER,TRAIT_EASYDISMEMBER,TRAIT_LIMBATTACHMENT,TRAIT_FAKEDEATH,TRAIT_XENO_IMMUNE,TRAIT_NOCLONELOSS,TRAIT_CAN_USE_FLIGHT_POTION, TRAIT_CAN_STRIP)
