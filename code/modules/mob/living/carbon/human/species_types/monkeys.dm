...
/datum/species/monkey/spec_unarmedattack(mob/living/carbon/human/user, atom/target)
	...
	if(HAS_TRAIT(user, TRAIT_HANDS_BLOCKED))
		...
		if(prob(25))
			victim.visible_message("<span class='danger'>[user] bite misses [victim]!</span>",
				"<span class='danger'>You avoid [user] bite!</span>", "<span class='hear'>You hear jaws snapping shut!</span>", COMBAT_MESSAGE_RANGE, user)
