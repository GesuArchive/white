...
/obj/effect/proc_holder/alien/proc/check_vent_block(mob/living/user)
	...
	if(atmos_thing)
		var/rusure = tgui_alert(user, "Laying eggs and shaping resin here would block access to [atmos_thing]. Do you want to continue?", "Blocking Atmospheric Component", "Yes", "No")
		if(rusure != "Yes")
			return FALSE
	return TRUE
