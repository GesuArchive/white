...
/obj/item/clothing/suit/space/space_ninja/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "атаку", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
	. = ..()
	if(stealth)
		cancel_stealth()
		s_coold = 5
...
/obj/item/clothing/suit/space/space_ninja/proc/lockIcons(mob/living/carbon/human/ninja)
	var/design_choice = tgui_alert(ninja, "Please choose your desired suit design.",,"Original","New Age")
...
/obj/item/clothing/suit/space/space_ninja/proc/lock_suit(mob/living/carbon/human/ninja)
	...
	if(!istype(ninja.head, /obj/item/clothing/head/helmet/space/space_ninja))
		to_chat(ninja, "<span class='userdanger'>ERROR</span>: 100113 ОТСУТСТВУЕТ ШЛЕМ\nОТКАЗ...")
		return FALSE
	if(!istype(ninja.shoes, /obj/item/clothing/shoes/space_ninja))
		to_chat(ninja, "<span class='userdanger'>ERROR</span>: 122011 ОТСУТСВУЮТ СПЕЦБОТИНКИ\nОТКАЗ...")
		return FALSE
	if(!istype(ninja.gloves, /obj/item/clothing/gloves/space_ninja))
		to_chat(ninja, "<span class='userdanger'>ERROR</span>: 110223 ОТСУТСТВУЮТ СПЕЦПЕРЧАТКИ\nОТКАЗ...")
		return FALSE
	affecting = ninja
