...
/datum/chemical_reaction/drink/salt_and_swell
	...
	required_reagents = list(/datum/reagent/consumable/ethanol/navy_rum = 4, /datum/reagent/consumable/toechtauese_syrup = 3, /datum/reagent/consumable/eggyolk = 5, /datum/reagent/medicine/salglu_solution = 1)
