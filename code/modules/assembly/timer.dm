...
/obj/item/assembly/timer/suicide_act(mob/living/user)
	user.visible_message(span_suicide("[user] looks at the timer and decides [user.ru_ego()] fate! It looks like [user.p_theyre()] going to commit suicide!"))
...
/obj/item/assembly/timer/proc/manual_suicide(mob/living/user)
	user.visible_message(span_suicide("[user] time is up!"))
