...
/obj/item/assembly/timer/suicide_act(mob/living/user)
	user.visible_message("<span class='suicide'>[user] looks at the timer and decides [user.ru_ego()] fate! It looks like [user.p_theyre()] going to commit suicide!</span>")
...
/obj/item/assembly/timer/proc/manual_suicide(mob/living/user)
	user.visible_message("<span class='suicide'>[user] time is up!</span>")
...
/obj/item/assembly/timer/examine(mob/user)
	. = ..()
	. += "<hr><span class='notice'>The timer is [timing ? "counting down from [time]":"set for [time] seconds"].</span>"
