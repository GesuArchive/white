...
/obj/item/assembly/flash/attack(mob/living/M, mob/user)
	...
	if(iscarbon(M))
		...
		user.visible_message("<span class='warning'>[user] overloads [R] sensors with the flash!</span>", "<span class='danger'>You overload [R] sensors with the flash!</span>")
		return TRUE
...
/obj/item/assembly/flash/proc/terrible_conversion_proc(mob/living/carbon/victim, mob/aggressor)
	...
	if(victim.stat != CONSCIOUS)
		to_chat(aggressor, "<span class='warning'>They must be conscious before you can convert [victim.ru_na()]!</span>")
		return
