...
/datum/round_event/wormholes/announce(fake)
	priority_announce("На станции обнаружены пространственно-временные аномалии. Нет никаких дополнительных данных.", "Аномальная тревога", 'sound/ai/announcer/anomaly.ogg')
