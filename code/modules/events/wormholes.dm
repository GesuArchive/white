...
/datum/round_event/wormholes/announce(fake)
	priority_announce("Ќа станции обнаружены пространственно-временные аномалии. Ќет никаких дополнительных данных.", "јномальна€ тревога", 'sound/ai/spanomalies.ogg')
