...
/datum/round_event/shuttle_loan/announce(fake)
	...
	switch(dispatch_type)
		if(HIJACK_SYNDIE)
			priority_announce("Снабжение: Синдикат пытается проникнуть на вашу станцию. Если вы позволите им угнать ваш грузовой шаттл, вы избавите нас от головной боли.","Контрразведка Центрального Командования")
		if(RUSKY_PARTY)
			priority_announce("Снабжение: Группа злых русских хочет устроить вечеринку. Можете отправить им ваш грузовой шаттл, чтобы заставить их исчезнуть?","ФМС Центрального Командования")
		if(SPIDER_GIFT)
			priority_announce("Снабжение: Клан Пауков прислал нам загадочный подарок. Мы можем отправить его вам, чтобы вы посмотрели, что внутри?","Дипломатический Корпус Центрального Командования")
		if(DEPARTMENT_RESUPPLY)
			priority_announce("Снабжение: Похоже, в этом месяце мы заказали в два раза больше посылок для пополнения запасов нашего департамента. Мы можем отправить их к вам?","Снабжение Центрального Командования")
			thanks_msg = "Грузовой шаттл должен вернуться через пять минут."
			bonus_points = 0
		if(ANTIDOTE_NEEDED)
			priority_announce("Снабжение: Ваша станция была выбрана для эпидемиологического исследовательского проекта. Отправьте нам ваш грузовой шаттл для получения образцов для исследования.", "Стартапы Центрального Командования")
		if(PIZZA_DELIVERY)
			priority_announce("Снабжение: Похоже, соседняя станция случайно доставила вам пиццу.", "Отдел Космопиццы Центрального Командования")
			thanks_msg = "Грузовой шаттл должен вернуться через пять минут."
			bonus_points = 0
		if(ITS_HIP_TO)
			priority_announce("Снабжение: Один из наших грузовиков с пчелами подвергся нападению со стороны эко-террористов. Вы можете убрать там всё за нас?", "Подразделение Уборщиков Центрального Командования")
...
/datum/round_event/shuttle_loan/proc/loan_shuttle()
	priority_announce(thanks_msg, "Грузовой Шаттл Центрального Командования", 'sound/ai/ru/announcer_synth/shuttle.ogg')
