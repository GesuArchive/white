	...
	if(SSshuttle.shuttle_loan && SSshuttle.shuttle_loan.dispatched)
		...
		switch(dispatch_type)
			...
			if(RUSKY_PARTY)
				...
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian/ranged/medic)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian/ranged/medic)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian/ranged/engineer)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian/ranged/engineer)
				shuttle_spawns.Add(/mob/living/simple_animal/hostile/russian/ranged/sniper)
