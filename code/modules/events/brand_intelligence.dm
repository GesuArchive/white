...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("Разгульный брэндовый интеллект был обнаружен на борту [station_name()]. Пожалуйста, приготовьтесь. Считается, что произошло это от [source].", "Тревога машинного обучения")
