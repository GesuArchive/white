...
/datum/round_event/high_priority_bounty/announce(fake)
	priority_announce("Центральное Командование выдало высокоприоритетную награду за груз. Детали были разосланы на все консоли грантов.", "Программы Грантов NanoTrasen")
