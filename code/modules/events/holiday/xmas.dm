...
/obj/item/toy/xmas_cracker/attack(mob/target, mob/user)
	if( !cracked && ishuman(target) && (target.stat == CONSCIOUS) && !target.get_active_held_item() )
		target.visible_message("<span class='notice'>[user] and [target] pop <b>[src.name]</b>! *pop*</span>", "<span class='notice'>You pull <b>[src.name]</b> with [target]! *pop*</span>", "<span class='hear'>You hear a pop.</span>")
