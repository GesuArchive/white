...
/datum/round_event/ghost_role/sentience/announce(fake)
	...
	var/data = pick("сканировани€ с наших датчиков дальнего радиуса действи€", "наших сложных веро€тностных моделей", "нашего всемогущества", "трафика св€зи на вашей станции", "эмиссии энергии, которые мы обнаружили", "\[REDACTED\]")
	var/pets = pick("животных/роботов", "роботов/животных", "питомцев", "простых животных", "меньших жизненных форм", "\[REDACTED\]")
	var/strength = pick("человеческий", "умеренный", "€щеринный", "надЄжный", "командный", "клоунский", "низкий", "очень низкий", "\[REDACTED\]")

	sentience_report += "”читыва€ данные [data], мы считаем, что [one] из [pets] развило [strength] уровень интеллекта и умение общатьс€."

	priority_announce(sentience_report,"ќбъ€вление средней важности")
