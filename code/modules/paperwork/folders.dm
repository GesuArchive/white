...
/obj/item/folder/suicide_act(mob/living/user)
	user.visible_message("<span class='suicide'>[user] начинает оформление мнимого смертного приговора! Судя по всему, он[user.ru_a()] пытается совершить суицид!</span>")
	return OXYLOSS
