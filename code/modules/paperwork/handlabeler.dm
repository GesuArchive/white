...
/obj/item/hand_labeler/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] указывает [src] на [user.ru_na()]self. [user.p_theyre(TRUE)] собирается обозначить [user.ru_na()]self как суицид!</span>")
