...
/datum/uplink_item/explosives/detomatix
	name = "Картридж ПДА \"Детоматикс\""
	desc = "При установке в ПДА этот картридж дает вам четыре заряда \
			для детонации ПДА остальных членов экипажа, у которых включена передача сообщений. \
			Заряд взорвет ПДА получателя и выведет из строя его пользователя на короткое время, оглушив его."
...
/datum/uplink_item/device_tools/frame
	name = "Картридж для ПДА F.R.A.M.E."
	desc = "При установке в ПДА этот картридж дает вам пять вирусов для КПК, которые \
			при использовании заставляют целевой КПК стать новым аплинком с нулевым ТК, и немедленно разблокируется. \
...
/datum/uplink_item/device_tools/potion
	...
	desc = "Зелье, добытое с большим риском для жизни оперативниками Синдиката под прикрытием, а затем модифицированное с помощью технологии Синдиката. \
			С помощью этого зелья любое животное становится разумным и обязано служить вам, а также вживляется внутреннее радио для связи и внутренняя идентификационная карта для открытия дверей."
	cost = 4
	purchasable_from = UPLINK_NUKE_OPS | UPLINK_CLOWN_OPS
	restricted = TRUE
...
/datum/uplink_item/role_restricted/mimery
	name = "Руководство по продвинутой мимикрии"
