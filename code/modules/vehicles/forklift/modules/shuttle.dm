/datum/forklift_module/shuttle
	...
	resource_price = list(
		/turf/open/floor/mineral/titanium = list(
			/datum/material/iron = MINERAL_MATERIAL_AMOUNT * 0.75,
			/datum/material/titanium = MINERAL_MATERIAL_AMOUNT * 0.25, // 1 rod for lattice = 0.5 iron, 1 floor tile for plating = 0.25 iron, 1 floor tile for covering = 0.25 titanium
		),
		/turf/open/floor/mineral/titanium/blue = list(
			/datum/material/iron = MINERAL_MATERIAL_AMOUNT * 0.75,
			/datum/material/titanium = MINERAL_MATERIAL_AMOUNT * 0.25,
		),
		...
		/turf/open/floor/mineral/plastitanium/red = list(
			/datum/material/iron = MINERAL_MATERIAL_AMOUNT * 0.75,
			/datum/material/titanium = MINERAL_MATERIAL_AMOUNT * 0.125,
			/datum/material/plasma = MINERAL_MATERIAL_AMOUNT * 0.125,
		),
