...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov
	name = "Саванна-Иванов"
	desc = "Безумно громоздкий мех, который ловко унижает операторов с одним пилотом. Цена в том, что вам нужно два пилота, чтобы использовать его."
...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov/proc/begin_skyfall_charge(mob/pilot)
	balloon_alert(pilot, "зарядка удара с небес...")
...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov/proc/skyfall_charge_loop(mob/living/pilot)
	...
	savannah_action.build_all_button_icons()
...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov/proc/abort_skyfall(mob/pilot)
	if(pilot)
		balloon_alert(pilot, "удар с небес отменён")
...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov/proc/start_missile_targeting(mob/gunner)
	balloon_alert(gunner, "режим целеуказания")
	aiming_ivanov = TRUE
	rockets_left = 3
...
/obj/vehicle/sealed/mecha/combat/savannah_ivanov/proc/drop_missile(mob/gunner, turf/target_turf)
	...
	strike_action.build_all_button_icons()
...
/obj/effect/skyfall_landingzone
	name = "индикатор точки приземления"
	desc = "Голографическая проекция, обозначающая зону приземления чего-то. Наверное, лучше отойти."
