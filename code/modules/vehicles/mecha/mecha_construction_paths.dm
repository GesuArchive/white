...
/datum/component/construction/unordered/mecha_chassis/custom_action(obj/item/I, mob/living/user, typepath)
	...
	if(.)
		var/atom/parent_atom = parent
		user.visible_message("<span class='notice'><b>[user]</b> подключает <b>[I]</b> к <b>[parent]</b>.</span>" , "<span class='notice'>Подключаю <b>[I.name]</b> к <b>[parent]</b>.</span>")
...
/datum/component/construction/mecha/ripley/custom_action(obj/item/I, mob/living/user, diff)
	...
	switch(index)
		if(1)
			user.visible_message("<span class='notice'><b>[user]</b> подключает гидравлическую систему <b>[parent]</b>.</span>" , "<span class='notice'>Подключаю гидравлическую систему <b>[parent]</b>.</span>")
		if(2)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> активирует гидравлическую систему <b>[parent]</b>.</span>" , "<span class='notice'>Активирую гидравлическую систему <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> отключает гидравлическую систему <b>[parent]</b>.</span>" , "<span class='notice'>Отключаю гидравлическую систему <b>[parent]</b>.</span>")
		if(3)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает проводку в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю проводку в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> деактивирует гидравлическую систему <b>[parent]</b>.</span>" , "<span class='notice'>Деактивирую гидравлическую систему <b>[parent]</b>.</span>")
		if(4)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> настраивает проводку в <b>[parent]</b>.</span>" , "<span class='notice'>Настраиваю проводку в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет проводку из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю проводку из <b>[parent]</b>.</span>")
		if(5)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> отключает проводку в <b>[parent]</b>.</span>" , "<span class='notice'>Отключаю проводку в <b>[parent]</b>.</span>")
		if(6)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет основную плату.</span>" , "<span class='notice'>Закрепляю основную плату.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет модуль центрального управления из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю модуль центрального управления из <b>[parent]</b>.</span>")
		if(7)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает основную плату.</span>" , "<span class='notice'>Откручиваю основную плату.</span>")
		if(8)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет модуль управления периферией.</span>" , "<span class='notice'>Закрепляю модуль управления периферией.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет модуль управления периферией из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю модуль управления периферией из <b>[parent]</b>.</span>")
		if(9)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает модуль управления периферией.</span>" , "<span class='notice'>Откручиваю модуль управления периферией.</span>")
		if(10)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет модуль сканирования.</span>" , "<span class='notice'>Закрепляю модуль сканирования.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет модуль сканирования из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю модуль сканирования из <b>[parent]</b>.</span>")
		if(11)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает модуль сканирования.</span>" , "<span class='notice'>Откручиваю модуль сканирования.</span>")
		if(12)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет <b>[I.name]</b>.</span>" , "<span class='notice'><b>[user]</b> закрепляю <b>[I.name]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет конденсатор из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю конденсатор из <b>[parent]</b>.</span>")
		if(13)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает конденсатор в <b>[parent]</b>.</span>" , "<span class='notice'>Откручиваю конденсатор в <b>[parent]</b>.</span>")
		if(14)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет аккумулятор.</span>" , "<span class='notice'>Закрепляю аккумулятор.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> вытаскивает аккумулятор из <b>[parent]</b>.</span>" , "<span class='notice'>Вытаскиваю аккумулятор из <b>[parent]</b>.</span>")
		if(15)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает внутреннюю обшивку <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю внутреннюю обшивку <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает аккумулятор.</span>" , "<span class='notice'>Откручиваю аккумулятор.</span>")
		if(16)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет внутреннюю обшивку.</span>" , "<span class='notice'>Закрепляю внутреннюю обшивку.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает внутреннюю обшивку <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю внутреннюю обшивку <b>[parent]</b>.</span>")
		if(17)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает внутреннюю обшивку к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю внутреннюю обшивку к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает внутреннюю обшивку.</span>" , "<span class='notice'>Откручиваю внутреннюю обшивку.</span>")
		if(18)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает внешнюю обшивку <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю внешнюю обшивку на <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> срезает внутреннюю обшивку с <b>[parent]</b>.</span>" , "<span class='notice'>Срезаю внутреннюю обшивку с <b>[parent]</b>.</span>")
		if(19)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет внешнюю обшивку.</span>" , "<span class='notice'>Закрепляю внешнюю обшивку.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает внешнюю обшивку <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю внешнюю обшивку <b>[parent]</b>.</span>")
		if(20)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает внешнюю обшивку к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю внешнюю обшивку к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает внешнюю обшивку.</span>" , "<span class='notice'>Откручиваю внешнюю обшивку.</span>")
	return TRUE
...
/datum/component/construction/mecha/gygax/custom_action(obj/item/I, mob/living/user, diff)
	...
	switch(index)
		...
		if(10)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет модуль управления оружием.</span>" , "<span class='notice'>Закрепляю модуль управления оружием.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет модуль управления оружием из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю модуль управления оружием из <b>[parent]</b>.</span>")
		if(11)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает модуль управления оружием.</span>" , "<span class='notice'>Откручиваю модуль управления оружием.</span>")
		if(12)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет модуль сканирования.</span>" , "<span class='notice'>Закрепляю модуль сканирования.</span>")
			else
		...
		if(14)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет конденсатор.</span>" , "<span class='notice'>Закрепляю конденсатор.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет конденсатор из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю конденсатор из <b>[parent]</b>.</span>")
		if(15)
			if(diff==FORWARD)
				...
				user.visible_message("<span class='notice'><b>[user]</b> откручивает конденсатор.</span>" , "<span class='notice'>Откручиваю конденсатор.</span>")
		if(16)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет аккумулятор.</span>" , "<span class='notice'>Закрепляю аккумулятор.</span>")
			else
		...
		if(21)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет Gygax Armor Plates.</span>" , "<span class='notice'>Закрепляю Gygax Armor Plates.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает Gygax Armor Plates с <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю Gygax Armor Plates с <b>[parent]</b>.</span>")
		if(22)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает Gygax Armor Plates к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю Gygax Armor Plates к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает Gygax Armor Plates.</span>" , "<span class='notice'>Откручиваю Gygax Armor Plates.</span>")
	return TRUE
...
/datum/component/construction/mecha/clarke/custom_action(obj/item/I, mob/living/user, diff)
	...
	switch(index)
		if(1)
			user.visible_message("<span class='notice'><b>[user]</b> устанавливает гусеницы.</span>" , "<span class='notice'>Устанавливаю гусеницы.</span>")
		if(2)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> подключает гидравлическую систему <b>[parent]</b>.</span>" , "<span class='notice'>Подключаю гидравлическую систему <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает гусеницы.</span>" , "<span class='notice'>Снимаю гусеницы.</span>")
		...
		if(19)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает внешнюю обшивку на <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю внешнюю обшивку на <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> срезает внутреннюю обшивку с <b>[parent]</b>.</span>" , "<span class='notice'>Срезаю внутреннюю обшивку с <b>[parent]</b>.</span>")
		if(20)
			if(diff==FORWARD)
				...
				user.visible_message("<span class='notice'><b>[user]</b> снимает внешнюю обшивку с <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю внешнюю обшивку с <b>[parent]</b>.</span>")
		if(21)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает внешнюю обшивку к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю внешнюю обшивку к <b>[parent]</b>.</span>")
			else
...
/datum/component/construction/mecha/honker/custom_action(obj/item/I, mob/living/user, diff)
	...
	if(istype(I, /obj/item/bikehorn))
		...
		user.visible_message("<span class='danger'>ХОНК!</span>")
	...
	switch(index)
		...
		if(12)
			user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
		if(14)
			user.visible_message("<span class='notice'><b>[user]</b> гениально устанавливает <b>[I.name]</b> на <b>[parent]</b>.</span>" , "<span class='notice'>Гениально устанавливаю <b>[I.name]</b> на <b>[parent]</b>.</span>")
		if(16)
			user.visible_message("<span class='notice'><b>[user]</b> гениально устанавливает <b>[I.name]</b> на <b>[parent]</b>.</span>" , "<span class='notice'>Гениально устанавливаю <b>[I.name]</b> на <b>[parent]</b>.</span>")
	return TRUE
...
/datum/component/construction/mecha/durand/custom_action(obj/item/I, mob/living/user, diff)
	...
	switch(index)
		...
		if(21)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет Durand Armor Plates.</span>" , "<span class='notice'>Закрепляю Durand Armor Plates.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает Durand Armor Plates с <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю Durand Armor Plates с <b>[parent]</b>.</span>")
		if(22)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает Durand Armor Plates к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю Durand Armor Plates к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает Durand Armor Plates.</span>" , "<span class='notice'>Откручиваю Durand Armor Plates.</span>")
	return TRUE
...
/datum/component/construction/mecha/phazon/custom_action(obj/item/I, mob/living/user, diff)
	...
	switch(index)
		...
		if(16)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> подключает блюспейс кристалл.</span>" , "<span class='notice'>Подключаю блюспейс кристалл.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> удаляет блюспейс кристалл из <b>[parent]</b>.</span>" , "<span class='notice'>Удаляю блюспейс кристалл из <b>[parent]</b>.</span>")
		if(17)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> активирует блюспейс кристалл.</span>" , "<span class='notice'>Активирую блюспейс кристалл.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> отключает блюспейс кристалл от <b>[parent]</b>.</span>" , "<span class='notice'>Отключаю блюспейс кристалл от <b>[parent]</b>.</span>")
		if(18)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'>Деактивирует блюспейс кристалл.</span>" , "<span class='notice'>Деактивирую блюспейс кристалл.</span>")
		if(19)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет аккумулятор.</span>" , "<span class='notice'>Закрепляю аккумулятор.</span>")
			else
		...
		if(20)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает фазовую броню на <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю фазовую броню на <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает аккумулятор.</span>" , "<span class='notice'>Откручиваю аккумулятор.</span>")
		if(21)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет фазовую броню.</span>" , "<span class='notice'>Закрепляю фазовую броню.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает фазовую броню с <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю фазовую броню с <b>[parent]</b>.</span>")
		if(22)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает фазовую броню к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю фазовую броню к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает фазовую броню.</span>" , "<span class='notice'>Откручиваю фазовую броню.</span>")
		if(23)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> устанавливает <b>[I.name]</b> в <b>[parent]</b>.</span>" , "<span class='notice'>Устанавливаю <b>[I.name]</b> в <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> срезает фазовую броню с <b>[parent]</b>.</span>" , "<span class='notice'>Срезаю фазовую броню с <b>[parent]</b>.</span>")
		if(24)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> закрепляет Phazon Armor Plates.</span>" , "<span class='notice'>Закрепляю Phazon Armor Plates.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> снимает Phazon Armor Plates с <b>[parent]</b>.</span>" , "<span class='notice'>Снимаю Phazon Armor Plates с <b>[parent]</b>.</span>")
		if(25)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> приваривает Phazon Armor Plates к <b>[parent]</b>.</span>" , "<span class='notice'>Привариваю Phazon Armor Plates к <b>[parent]</b>.</span>")
			else
				user.visible_message("<span class='notice'><b>[user]</b> откручивает Phazon Armor Plates.</span>" , "<span class='notice'>Откручиваю Phazon Armor Plates.</span>")
		if(26)
			if(diff==FORWARD)
				user.visible_message("<span class='notice'><b>[user]</b> аккуратно вставляет ядро блюспейс аномалии в <b>[parent]</b> и закрепляет его.</span>" ,
					"<span class='notice'>Аккуратно вставляю ядро блюспейс аномалии в специальный отсек и закрепляю его.</span>")
	return TRUE
