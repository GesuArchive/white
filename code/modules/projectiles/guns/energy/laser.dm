...
/obj/item/gun/energy/laser/captain
	...
	desc = "Это антикварный лазерный пистолет. Ручной работы высшего качества. Декорирован кожей ассистента и хромом. Испускает пронизывающие лучи чистой энергии. На пистолете есть изображение Космической Станции 13. А точнее взрывающейся Космической Станции 13."
	force = 10
	ammo_x_offset = 3
	selfcharge = 1
