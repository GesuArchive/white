...
/obj/item/gun/ballistic/rocketlauncher/suicide_act(mob/living/user)
	...
	if(can_shoot())
		...
		sleep(20)
		user.visible_message(span_warning("[user] looks about the room realizing [user.p_theyre()] still there. [user.ru_who(TRUE)] proceed to shove [src] down their throat and choke [user.ru_na()]self with it!") , \
