	...
	if(suppressed)
		...
		if(message)
			if(pointblank)
				...
				user.visible_message("<span class='danger'><b>[user]</b> �������� �� <b>[src.name]</b>!</span>", \
								"<span class='danger'>�� ��������� �� [src.name]!</span>", \
								"<span class='hear'>�� ������� �������!</span>", COMBAT_MESSAGE_RANGE)
	...
	if(clumsy_check)
		if(istype(user))
			if (HAS_TRAIT(user, TRAIT_CLUMSY) && prob(40))
				to_chat(user, "<span class='userdanger'>�� ��������� ���� � ���� �� [src]!</span>")
