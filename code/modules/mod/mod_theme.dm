...
/datum/mod_theme/engineering
	name = "engineering"
	ru_name = "инженерный"
	desc = "Инженерный MOD Скафандр с интегрированной защитой от электричества и повышенной термостойкостью. Классика Накамура Инженеринг."
...
/datum/mod_theme/research
	...
	extended_desc = "Частный военный скафандр для обезвреживания боеприпасов от Аусек Армори, основанный на работе Накамура Инжениринг. \
		...
		превосходит даже самые лучшие стандартные MOD-Скафандры. Однако, несмотря на свой иммунитет против \
...
/datum/mod_theme/security
	...
	extended_desc = "Эта модель MOD-Скафандра была разработана для быстрого реагирования на \
...
/datum/mod_theme/cosmohonk
	...
	extended_desc = "Космохонк MOD-Скафандр был первоначально разработан для межзвездной комедии в условиях низкого юмора. \
...
/datum/mod_theme/enchanted
	...
	desc = "Относительно низкотехнологичный MOD-Скафандр Федерации Волшебников. Очень защищённый, хотя..."
	extended_desc = "Магически адаптированный MOD-Скафандр Федерации Волшебников. В этой броне не используется \
