...
/datum/surgery_step/hepatectomy/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, "<span class='notice'>You begin to cut out a damaged piece of [target] liver...</span>",
...
/datum/surgery_step/hepatectomy/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_results(user, target, "<span class='notice'>You successfully remove the damaged part of [target] liver.</span>",
		"<span class='notice'>[user] successfully removes the damaged part of [target] liver.</span>",
		"<span class='notice'>[user] successfully removes the damaged part of [target] liver.</span>")
	return ..()
...
/datum/surgery_step/hepatectomy/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery)
	...
	display_results(user, target, "<span class='warning'>You cut the wrong part of [target] liver!</span>",
		"<span class='warning'>[user] cuts the wrong part of [target] liver!</span>",
		"<span class='warning'>[user] cuts the wrong part of [target] liver!</span>")
