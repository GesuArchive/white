...
/datum/surgery_step/ground_nerves/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, "<span class='notice'>Начинаю перенаправлять нервы [skloname(target.name, RODITELNI, target.gender)].</span>" ,
		"<span class='notice'>[user] начал перенаправлять нервы [skloname(target.name, RODITELNI, target.gender)].</span>" ,
...
/datum/surgery_step/ground_nerves/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	display_results(user, target, "<span class='notice'>Успешно перенаправил нервную систему [skloname(target.name, RODITELNI, target.gender)]!</span>" ,
		"<span class='notice'>[user] успешно перенаправил нервную систему [skloname(target.name, RODITELNI, target.gender)]!</span>" ,
