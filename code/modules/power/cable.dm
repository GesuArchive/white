...
/obj/structure/cable/proc/get_power_info()
	if(powernet?.avail > 0)
		return "<span class='danger'>Суммарная мощность: [display_power(powernet.avail)]\nНагрузка: [display_power(powernet.load)]\nИзлишки: [display_power(surplus())]</span>"
	else
...
/obj/structure/cable/multilayer/examine(mob/user)
	. += ..()
	. += "<hr><span class='notice'>L1:[cable_layer & CABLE_LAYER_1 ? "Connect" : "Disconnect"].</span>"
	. += "<span class='notice'>\nL2:[cable_layer & CABLE_LAYER_2 ? "Connect" : "Disconnect"].</span>"
	. += "<span class='notice'>\nL3:[cable_layer & CABLE_LAYER_3 ? "Connect" : "Disconnect"].</span>"
	. += "<span class='notice'>\nM:[machinery_layer & MACHINERY_LAYER_1 ? "Connect" : "Disconnect"].</span>"
