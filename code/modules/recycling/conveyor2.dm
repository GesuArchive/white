...
/obj/machinery/conveyor/attackby(obj/item/I, mob/user, params)
	if(I.tool_behaviour == TOOL_CROWBAR)
		user.visible_message("<span class='notice'>[user] struggles to pry up <b>[src.name]</b> with [I].</span>", \
		"<span class='notice'>You struggle to pry up <b>[src.name]</b> with [I].</span>")
