...
/datum/antagonist/nukeop/greet()
	owner.current.playsound_local(get_turf(owner.current), 'white/valtos/sounds/menu_loop.ogg',100,0, use_reverb = FALSE)
...
/datum/team/nuclear/roundend_report()
	...
	switch(get_result())
		...
		if(NUKE_RESULT_NOSURVIVORS)
			...
			parts +=  "<B>Оперативники Синдиката оперативники уничтожили [station_name()], но не покинули зону поражения вовремя и были аннигилированы.</B> Не теряйте диск!"
