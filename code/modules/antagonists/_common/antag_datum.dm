...
/datum/antagonist
	var/name = "Antagonist"
	var/roundend_category = "другие антаги"				//Section of roundend report, datums with same category will be displayed together, also default header for the section
...
/datum/antagonist/proc/replace_banned_player()
	...
	var/list/mob/dead/observer/candidates = poll_candidates_for_mob("Do you want to play as a [name]?", "[name]", null, 50, owner.current)
...
/datum/antagonist/proc/roundend_report_header()
	return 	"<span class='header'>[capitalize(roundend_category)]:</span><br>"
