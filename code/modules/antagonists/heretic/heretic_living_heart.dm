...
/datum/action/item_action/organ_action/track_target
	name = "Сердцебиение"
	desc = "ЛКМ: Выбрать цель для отслеживания. ПКМ: Отслеживать выбранную ранее цель."
...
/datum/action/item_action/organ_action/track_target/Trigger(trigger_flags)
	...
	if(!LAZYLEN(heretic_datum.sac_targets))
		owner.balloon_alert(owner, "нет целей, посетите руну!")
		return TRUE
	...
	if(tracked_mob.stat == DEAD)
		balloon_message = "мертва, " + balloon_message
