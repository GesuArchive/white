...
/obj/item/codex_cicatrix/examine(mob/user)
	...
	. += "<span class='notice'><hr>Can be used to tap influences for additional knowledge points.</span>"
	. += "<span class='notice'>\nCan also be used to draw or remove transmutation runes with ease.</span>"
