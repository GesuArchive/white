...
GLOBAL_LIST_INIT(blacklisted_malf_machines, typecacheof(list(
		...
		//HFRT /obj/machinery/atmospherics/components/unary/hypertorus/core,
		//HFRT /obj/machinery/atmospherics/components/unary/hypertorus/waste_output,
		//HFRT /obj/machinery/atmospherics/components/unary/hypertorus/moderator_input,
		//HFRT /obj/machinery/atmospherics/components/unary/hypertorus/fuel_input,
		//HFRT /obj/machinery/hypertorus/interface,
		//HFRT /obj/machinery/hypertorus/corner,
