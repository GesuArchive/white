...
/datum/contractor_item/blackout/handle_purchase(datum/contractor_hub/hub)
	...
	if (.)
		power_fail(35, 50)
		priority_announce("Abnormal activity detected in [station_name()] powernet. As a precautionary measure, the station's power will be shut off for an indeterminate duration.", "Critical Power Failure", 'sound/ai/poweroff.ogg')
