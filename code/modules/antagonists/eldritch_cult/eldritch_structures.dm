/obj/structure/eldritch_crucible
	name = "Тигель"
	desc = "Увековеченный чугун, стальные зубы, удерживающие его на месте, этот мерзкий котёл обладает способностью пересоздавать вещи, переделывать их с самого начала."
