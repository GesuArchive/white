...
/datum/reagent/proc/addiction_act_stage1(mob/living/M)
	...
	if(prob(30))
		to_chat(M, "<span class='notice'>Кажется, мне не помешает принять немного [name] прямо сейчас.</span>")
	return
...
/datum/reagent/proc/addiction_act_stage2(mob/living/M)
	...
	if(prob(30))
		to_chat(M, "<span class='notice'>Кажется мне нужен [name]. Я просто не могу без него.</span>")
	return
...
/datum/reagent/proc/addiction_act_stage3(mob/living/M)
	...
	if(prob(30))
		to_chat(M, "<span class='danger'>У меня сильная ломка по [name].</span>")
	return
...
/datum/reagent/proc/addiction_act_stage4(mob/living/M)
	...
	if(prob(30))
		to_chat(M, "<span class='boldannounce'>Мне совсем не хорошо! Мне очень нужен [name].</span>")
	return
