...
/datum/chemical_reaction/foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam,2*created_volume,notification="<span class='danger'>Раствор испускает пену!</span>")
	reaction_tags = REACTION_TAG_EASY | REACTION_TAG_UNIQUE
...
/datum/chemical_reaction/metalfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,1,"<span class='danger'>Раствор испускает металлическую пену!</span>")
...
/datum/chemical_reaction/smart_foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal/smart,5*created_volume,1,"<span class='danger'>Раствор выделяет металлическую пену!</span>")
...
/datum/chemical_reaction/ironfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,2,"<span class='danger'>Раствор испускает металлическую пену!</span>")
...
/datum/chemical_reaction/resin_foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,3,"<span class='danger'>Раствор выделяет противопожарную пену!</span>")
