...
/datum/chemical_reaction/metalfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,1,span_danger("Раствор испускает металлическую пену!"))
...
/datum/chemical_reaction/smart_foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal/smart,5*created_volume,1,span_danger("Раствор выделяет металлическую пену!"))
...
/datum/chemical_reaction/ironfoam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,2,span_danger("Раствор испускает металлическую пену!"))
...
/datum/chemical_reaction/resin_foam/on_reaction(datum/reagents/holder, datum/equilibrium/reaction, created_volume)
	holder.create_foam(/datum/effect_system/fluid_spread/foam/metal,5*created_volume,3,span_danger("Раствор выделяет противопожарную пену!"))
