/obj/item/reagent_containers/blood
	name = "пакет крови"
	desc = "Содержит кровь используемую при переливании. Должна быть зафиксирована на капельнице."
...
/obj/item/reagent_containers/blood/attackby(obj/item/I, mob/user, params)
	if (istype(I, /obj/item/pen) || istype(I, /obj/item/toy/crayon))
		if(!user.is_literate())
			to_chat(user, "<span class='notice'>Я неразборчиво написал на этикетке [src]!</span>")
			return
