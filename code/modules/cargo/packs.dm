...
/datum/supply_pack/critter/cat
	...
	cost = BUY_CRATE_VALUE * 10 //Cats are worth as much as corgis.
	access_view = ACCESS_MEDICAL
...
/datum/supply_pack/costumes_toys/randomised/toys
	...
	cost = BUY_CRATE_VALUE * 8 // or play the arcade machines ya lazy bum
	num_contained = 5
	contains = list()
...
/datum/supply_pack/misc/empty
	...
	cost = BUY_CRATE_VALUE * 0.6 //Empty pod, so no crate refund
	contains = list()
	DropPodOnly = TRUE
	crate_type = null
...
/datum/supply_pack/misc/religious_supplies
	...
	cost = BUY_CRATE_VALUE * 6	// it costs so much because the Space Church needs funding to build a cathedral
	access_view = ACCESS_CHAPEL_OFFICE
