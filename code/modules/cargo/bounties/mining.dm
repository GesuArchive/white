...
/datum/bounty/item/mining/bone_talisman
	...
	description = "Директор исследования станции 14 утверждает, что талисманы язычников из костей защищают своего владельца. Поставьте их несколько, чтобы они могли начать тестирование."
	reward = 7500
	required_count = 3
