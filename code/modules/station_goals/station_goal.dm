...
/datum/station_goal/proc/send_report()
	priority_announce("Получена приоритетная директива Нанотрейзен. Проект \"[name]\", детали разосланы.", "Входящее приоритетное сообщение", SSstation.announcer.get_rand_report_sound())
