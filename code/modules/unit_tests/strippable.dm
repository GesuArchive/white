/datum/unit_test/strip_menu_ui_status/Run()
	...
	var/obj/target = allocate(/obj/item/pen, run_loc_bottom_left)
	var/datum/element/strippable/strippable = target.AddElement(/datum/element/strippable, list())

	var/mob/living/carbon/human/user = allocate(/mob/living/carbon/human, run_loc_bottom_left)
	...
	user.forceMove(locate(run_loc_bottom_left.x + 2, run_loc_bottom_left.y, run_loc_bottom_left.z))
	...
	observer.forceMove(run_loc_bottom_left)
	...
	var/mob/living/silicon/robot/borg = allocate(/mob/living/silicon/robot, run_loc_bottom_left)
	...
	borg.forceMove(locate(run_loc_bottom_left.x + 2, run_loc_bottom_left.y, run_loc_bottom_left.z))
	TEST_ASSERT_EQUAL(strip_menu.ui_status(borg, ui_state), UI_UPDATE, "Being too far away as a borg was not update-only.")

	var/mob/living/carbon/alien/rouny = allocate(/mob/living/carbon/alien, run_loc_bottom_left)
	...
	var/mob/living/simple_animal/pet/dog/corgi/corgi = allocate(/mob/living/simple_animal/pet/dog/corgi, run_loc_bottom_left)
