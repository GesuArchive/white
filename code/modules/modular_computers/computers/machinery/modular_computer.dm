...
/obj/machinery/modular_computer
	...
	var/base_active_power_usage = 1000					// Power usage when the computer is open (screen is active) and can be interacted with. Remember hardware can use power too.
