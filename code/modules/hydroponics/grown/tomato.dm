...
/obj/item/food/grown/tomato/blue/bluespace/Initialize(mapload, obj/item/seeds/new_seed)
	. = ..()
	AddElement(/datum/element/plant_backfire, TYPE_PROC_REF(/obj/item/food/grown/tomato/blue/bluespace, splat_user), extra_genes = list(/datum/plant_gene/trait/squash))
...
/obj/item/food/grown/tomato/killer/Initialize(mapload, obj/item/seeds/new_seed)
	. = ..()
	AddElement(/datum/element/plant_backfire, TYPE_PROC_REF(/obj/item/food/grown/tomato/killer, early_awaken), extra_genes = list(/datum/plant_gene/trait/squash))
