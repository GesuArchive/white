...
/obj/item/seeds/cannabis/death
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/toxin/cyanide = 0.35, /datum/reagent/drug/thc = 0.15)
	rarity = 40
...
/obj/item/seeds/cannabis/white
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/medicine/omnizine = 0.35, /datum/reagent/drug/thc = 0.15)
	rarity = 40
...
/obj/item/seeds/cannabis/ultimate
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/drug/thc = 0.3,
