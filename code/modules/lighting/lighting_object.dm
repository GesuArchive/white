...
/turf/proc/list_optimized_light_update()
	...
	var/list/red_struct
	var/list/green_struct
	var/list/blue_struct
	var/list/alpha_struct

	#ifndef SPACEMAN_DMM // crutch to bypass linter warnings
	red_struct = (lighting_corner_SW || dummy_lighting_corner).light_struct
	green_struct = (lighting_corner_SE || dummy_lighting_corner).light_struct
	blue_struct = (lighting_corner_NW || dummy_lighting_corner).light_struct
	alpha_struct = (lighting_corner_NE || dummy_lighting_corner).light_struct
	#endif
