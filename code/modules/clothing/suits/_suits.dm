/obj/item/clothing/suit
	...
	allowed = list(/obj/item/tank/internals/emergency_oxygen, /obj/item/tank/internals/plasmaman, /obj/item/watertank)
...
/obj/item/clothing/suit/worn_overlays(mutable_appearance/standing, isinhands = TRUE, icon_file)
	. = ..()
	if(!isinhands)
		if(damaged_clothes)
