...
/obj/item/clothing/accessory/attackby_secondary(obj/item/weapon, mob/user, params)
...
/obj/item/clothing/accessory/lawyers_badge/attack_self(mob/user)
	...
	user.visible_message("<span class='notice'>[user] shows [user.ru_ego()] attorney's badge.</span>", "<span class='notice'>You show your attorney's badge.</span>")
