...
/obj/item/clothing/glasses/suicide_act(mob/living/carbon/user)
	user.visible_message("<span class='suicide'>[user] тычет \the [src] в [user.ru_ego()] глаза! Выглядит так, будто [user.p_theyre()] пытается покончить с собой!</span>")
	return BRUTELOSS
...
/obj/item/clothing/glasses/godeye/double
	name = "глаза божьи"
	desc = "Пара странных глаз, которые, как говорят, были оторваны от всезнающего существа, которое бродило по пустошам. Нет никакой реальной причины иметь два, но это не останавливает вас."
