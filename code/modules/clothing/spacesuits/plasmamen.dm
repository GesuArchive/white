...
/obj/item/clothing/suit/space/eva/plasmaman/examine(mob/user)
	. = ..()
	. += "<hr><span class='notice'>There [extinguishes_left == 1 ? "is" : "are"] [extinguishes_left] extinguisher charge\s left in this suit.</span>"
...
/obj/item/clothing/suit/space/eva/plasmaman/proc/Extinguish(mob/living/carbon/human/H)
	...
	if(H.fire_stacks)
		if(extinguishes_left)
			...
			extinguishes_left--
			H.visible_message("<span class='warning'>[H]'s костюм автоматически тушит [H.ru_na()]!</span>","<span class='warning'>В костюме сработала система пожаротушения.</span>")
			H.extinguish_mob()
