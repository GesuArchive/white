/obj/item/clothing/gloves/tackler
	name = "перчатки с приводом захвата"
...
/obj/item/clothing/gloves/tackler/dolphin
	...
	desc = "Гладкие аэродиномичные перчатки с приводом захвата, которые менее эффективны при бросках, но куда более эффективны при скольжении по корридорам и непреднамеренной порчи имущества и здоровья."
...
/obj/item/clothing/gloves/tackler/combat
	...
	desc = "Боевые перчатки премиум качества, сильно усиленные чтобы предоставить владельцу преимущество в ближнем бою, однако их использование изматывает сильнее, чем у обычных перчаток с приводом захвата. К тому же они огнеупорны!"
	icon_state = "black"
...
/obj/item/clothing/gloves/tackler/offbrand
	name = "импровизированные перчатки с хватательным приводом"
