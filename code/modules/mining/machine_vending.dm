...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("ИРП-4",						/obj/item/storage/mre,												215),
		new /datum/data/mining_equipment("ИРП-6",						/obj/item/storage/mre/protein,										235),
		new /datum/data/mining_equipment("ИРП-47",						/obj/item/storage/mre/vegan,										290),
