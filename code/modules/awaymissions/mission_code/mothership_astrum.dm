...
/mob/living/simple_animal/hostile/abductor
	...
	icon = 'white/valtos/icons/astrum/abductors.dmi'
...
/obj/item/gun/energy/alien/zeta
	...
	icon = 'white/valtos/icons/astrum/alienblaster.dmi'
	lefthand_file = 'white/valtos/icons/astrum/alienhand.dmi'
	righthand_file = 'white/valtos/icons/astrum/alienhand2.dmi'
