/obj/item/skillchip/job/research_director
	...
	skill_icon = "dumbbell"
	activate_message = span_notice("You realise if you apply the correct force, at the correct angle, it is possible to make the immovable permamently movable.")
	deactivate_message = span_notice("You forget how to permamently anchor a paradoxical object.")
