/client/proc/reestablish_db_connection()
	...
	if (SSdbcore.IsConnected())
		...
		var/reconnect = tgui_alert(usr, "The database is already connected! If you *KNOW* that this is incorrect, you can force a reconnection", "The database is already connected!", "Force Reconnect", "Cancel")
