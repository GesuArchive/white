/client/proc/manipulate_organs(mob/living/carbon/C in world)
	...
	set category = "Дбг"
	var/operation = tgui_input_list(usr, "Select organ operation.", "Organ Manipulation", list("add organ", "add implant", "drop organ/implant", "remove organ/implant", "cancel"), "cancel")
	if (!operation)
		return
