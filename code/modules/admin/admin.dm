...
/datum/admins/proc/show_player_panel(mob/M in world)
	...
	if(M.client)
		...
		body += "<br><b>Бьёнд:</b> [M.client.account_join_date]"
	...
	body += "<A href='?_src_=holder;[HrefToken()];jumpto=[REF(M)]'><b>Телепорт</b></A>"
	body += "<A href='?_src_=holder;[HrefToken()];getmob=[REF(M)]'>К себе</A>"
	...
	body += "<A href='?_src_=holder;[HrefToken()];subtlemessage=[REF(M)]'>SM</A>"
	body += "<A href='?_src_=holder;[HrefToken()];playsoundto=[REF(M)]'>PS</A>"
	body += "<A href='?_src_=holder;[HrefToken()];languagemenu=[REF(M)]'>LM</A>"
