...
/proc/curse_of_madness(mob/user, message)
	...
	deadchat_broadcast("<span class='name'>Безумие</span> охватывает станцию, разбивая разумы экипажа загадочной фразой: \"<span class='big hypnophrase'>[message]</span>\"", message_type=DEADCHAT_ANNOUNCEMENT)
