...
/obj/effect/proc_holder/spell/pointed/barnyardcurse/cast(list/targets, mob/user)
	...
	if(target.anti_magic_check())
		...
		target.visible_message(span_danger("[target] face bursts into flames, which instantly burst outward, leaving [target] unharmed!") , \
	...
	target.visible_message(span_danger("[target] face bursts into flames, and a barnyard animal's head takes its place!") , \
