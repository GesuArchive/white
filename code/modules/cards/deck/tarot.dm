...
/obj/item/toy/cards/deck/tarot/haunted/on_wield(obj/item/source, mob/living/carbon/user)
	...
	to_chat(user, "<span class='notice'>The veil to the underworld is opened. You can sense the dead souls calling out...</span>")
...
/obj/item/toy/cards/deck/tarot/haunted/on_unwield(obj/item/source, mob/living/carbon/user)
	...
	to_chat(user, "<span class='notice'>The veil to the underworld closes shut. You feel your senses returning to normal.</span>")
