...
/datum/preferences/proc/load_preferences()
	...
	*/
	...
	UI_style		= sanitize_inlist(UI_style, GLOB.available_ui_styles, GLOB.available_ui_styles["Neoscreen"])
	...
	multiz_performance	= sanitize_integer(multiz_performance, -1, 3, initial(multiz_performance))
...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["forced_voice"], 			forced_voice)
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["forced_voice"],			forced_voice)
