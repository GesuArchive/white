...
/datum/job/head_of_personnel/announce(mob/living/carbon/human/H, announce_captaincy = FALSE)
	...
	if(announce_captaincy)
		SSticker.OnRoundstart(CALLBACK(GLOBAL_PROC, PROC_REF(minor_announce), "Учитывая нехватку экипажа, текущим капитаном станции теперь является [H.real_name]!"))
...
/datum/outfit/job/hop
	...
	backpack_contents = list(/obj/item/storage/box/ids=1,\
		/obj/item/melee/classic_baton/telescopic=1, /obj/item/card/id/departmental_budget/civ=1, /obj/item/card/id/departmental_budget/srv=1)
