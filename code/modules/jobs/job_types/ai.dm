...
/datum/job/ai/announce(mob/living/silicon/ai/AI)
	. = ..()
	SSticker.OnRoundstart(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(minor_announce), "[AI] был загружен в пустое ядро искусственного интеллекта из блюспейс сети: [AREACOORD(AI)]."))
