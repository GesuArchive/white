...
/datum/controller/subsystem/economy/proc/price_update()
	...
	earning_report = "Экономический отчет сектора<br /> В настоящее время цены поставщиков в секторе [SSeconomy.inflation_value()*100]%.<br /> Расходная мощность станции в настоящее время <b>[station_total] кредитов</b>, а целевое довольствие экипажа составляет <b>[station_target] кредитов</b>.<br /> Это всё от <i>Отдел экономистов Нанотрейзен</i>."
