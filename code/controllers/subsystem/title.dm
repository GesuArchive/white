...
/obj/rs_rs_rs/Initialize()
	...
	animate(src, transform = matrix().Scale(soe,soe), pixel_x = rand(-48, 48), time = rand(25, 50), loop = -1, flags = ANIMATION_PARALLEL)
	animate(	 transform = matrix().Scale(zof,zof), pixel_x = rand(-48, 48), time = rand(100, 200))
	animate(	 transform = matrix().Scale(soe,soe), pixel_x = rand(-48, 48), time = rand(25, 50))

	animate(src, transform = turn(matrix(), lor),   pixel_y = rand(-48, 48),   time = rand(25, 50), loop = -1, flags = ANIMATION_PARALLEL)
	animate(	 transform = turn(matrix(), lor*2), pixel_y = rand(-48, 48),   time = rand(100, 200))
	animate(	 transform = turn(matrix(), lor*3), pixel_y = rand(-48, 48),   time = rand(25, 50))
