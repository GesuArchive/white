...
/datum/controller/subsystem/security_level/proc/announce_security_level(datum/security_level/selected_level)
	if(selected_level.number_level > current_security_level.number_level) // We are elevating to this level.
		minor_announce(selected_level.elevating_to_announcemnt, "Внимание! Уровень безопасности повышен до [selected_level.ru_name] уровня!", sound_override = selected_level.sound)
	else // Going down
		minor_announce(selected_level.lowering_to_announcement, "Внимание! Уровень безопасности понижен до [selected_level.ru_name] уровня!", sound_override = selected_level.sound)
