...
/obj/item/integrated_circuit/passive/power/chemical_cell
	...
	spawn_flags = IC_SPAWN_DEFAULT|IC_SPAWN_RESEARCH
	var/volume = 60
	var/list/fuel = list(	/datum/reagent/toxin/plasma = 50000,
	 						/datum/reagent/toxin/slimejelly = 22500,
	 						/datum/reagent/fuel = 15000, /datum/reagent/carbon = 10000,
	 						/datum/reagent/consumable/ethanol = 10000,
	 						/datum/reagent/consumable/nutriment = 8000)
	var/multi = 1
	var/lfwb =TRUE
