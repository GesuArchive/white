...
/datum/action/item_action/nanosuit/goggletoggle
	name = "Night Vision"
	icon_icon = 'code/shitcode/valtos/icons/nanosuit/actions_nanosuit.dmi'
...
/obj/item/clothing/suit/space/hardsuit/nano/equipped(mob/user, slot)
	...
	if(slot == ITEM_SLOT_OCLOTHING)
		...
		if(is_station_level(T.z))
			priority_announce("[user] использовал[user.ru_a()] запрещённый нанокостюм в [A.map_name]!","Экстренное сообщение!", sound = 'code/shitcode/valtos/sounds/nanosuitengage.ogg')
...
/obj/item/clothing/suit/space/hardsuit/nano/proc/open_mode_menu(mob/living/user)
	...
	"armor" = image(icon = 'code/shitcode/valtos/icons/nanosuit/actions_nanosuit.dmi', icon_state = "armor_menu"),
	"speed" = image(icon = 'code/shitcode/valtos/icons/nanosuit/actions_nanosuit.dmi', icon_state = "speed_menu"),
	"cloak" = image(icon = 'code/shitcode/valtos/icons/nanosuit/actions_nanosuit.dmi', icon_state = "cloak_menu"),
	"strength" = image(icon = 'code/shitcode/valtos/icons/nanosuit/actions_nanosuit.dmi', icon_state = "strength_menu")
	)
