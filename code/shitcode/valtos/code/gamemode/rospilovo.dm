/obj/structure/flora/rospilovo
	name = "растительность"
	icon = 'code/shitcode/valtos/icons/rospilovo/flora.dmi'
...
/turf/open/floor/grass/rospilovo
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/grass.dmi'
	icon_state = "grass1"
	color = "#ffffaa"
...
/turf/closed/wall/rospilovo/beton
	name = "стена"
	desc = "Здоровенная, пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/beton_tg.dmi'
	icon_state = "beton"
	canSmoothWith = list(
	/turf/closed/wall/rospilovo/beton,
	/turf/closed/wall/rospilovo/beton_agro
...
/turf/closed/wall/rospilovo/bricks
	name = "стена"
	desc = "Здоровенная, пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/bricks_tg.dmi'
	icon_state = "bricks"
	canSmoothWith = list(
	/turf/closed/wall/rospilovo/bricks
	)
...
/turf/closed/wall/rospilovo/bricks_yellow
	name = "стена"
	desc = "Здоровенная, пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/bricks_tg_yellow.dmi'
	icon_state = "bricks"
	canSmoothWith = list(
	/turf/closed/wall/rospilovo/bricks_yellow
	)
...
/turf/closed/wall/rospilovo/bricks_white
	name = "стена"
	desc = "Здоровенная, пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/bricks_tg_white.dmi'
	icon_state = "bricks"
	canSmoothWith = list(
	/turf/closed/wall/rospilovo/bricks_white
	)
...
/turf/closed/wall/rospilovo/beton_agro
	name = "стена"
	desc = "Здоровенная, пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/beton_w_tg.dmi'
	icon_state = "beton"
	canSmoothWith = list(
	/turf/closed/wall/rospilovo/beton_agro
	)
...
/obj/structure/chair/brevno
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/decor.dmi'
	icon_state = "log1"
...
/obj/structure/flora/ausbushes/rospilovo
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/ausflora.dmi'
...
/obj/structure/table/rospilovo
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/stol_stalker.dmi'
	icon_state = "stol"
	smooth = SMOOTH_TRUE
	canSmoothWith = list(/obj/structure/table/rospilovo)
...
/obj/structure/rospilovo/okno
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/decor2.dmi'
	pass_flags = LETPASSTHROW
	density = 0
	opacity = 0
...
/obj/structure/rospilovo/tree
	name = "дерево"
	icon = 'code/shitcode/valtos/icons/rospilovo/derevya.dmi'
	icon_state = "derevo1"
	density = 0
	opacity = 0
	layer = 9
...
/obj/structure/rospilovo/polka
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/polka.dmi'
	icon_state = "polka"
	density = 1
	anchored = 1
...
/obj/structure/rospilovo/yashik/yaskik_a/big
	icon = 'code/shitcode/valtos/icons/rospilovo/decorations_32x64.dmi'
	icon_state = "crate"
...
/obj/structure/rospilovo/cover
	name = "ковёр"
	icon = 'code/shitcode/valtos/icons/rospilovo/cover.dmi'
	icon_state = "cover"
...
/obj/structure/rospilovo/clocks
	name =  "часы"
	desc = "Остановились."
	icon = 'code/shitcode/valtos/icons/rospilovo/decorations_32x32.dmi'
	icon_state = "clocks"
	density = 0
...
/obj/structure/rospilovo/intercom
	name = "домофон"
	desc = "Да..."
	icon = 'code/shitcode/valtos/icons/rospilovo/backwater.dmi'
	icon_state = "intercom"
	density = 0
...
/obj/structure/rospilovo/bigyashik
	name = "здоровый ящик"
	icon = 'code/shitcode/valtos/icons/rospilovo/decorations_64x64.dmi'
...
/obj/structure/rospilovo/trubas
	...
	icon = 'code/shitcode/valtos/icons/rospilovo/trubas.dmi'
	icon_state = "trubas"
	density = 1
...
/obj/structure/rospilovo/bunker
	name = "бункер"
	icon = 'code/shitcode/valtos/icons/rospilovo/bunker.dmi'
	density = 1
	opacity = 1
...
/obj/structure/fluff/rospilovo
	name = "машина"
	desc = "Ржавая пиздец."
	icon = 'code/shitcode/valtos/icons/rospilovo/decor128.dmi'
	icon_state = "civilgruz"
	density = TRUE

/obj/structure/fluff/rospilovo/gruzovik
	icon = 'code/shitcode/valtos/icons/rospilovo/gruzovik.dmi'
	icon_state = "gruzovik_v"

/obj/structure/grille/rospilovo
	desc = "Крепкий железный забор."
	name = "забор"
	icon = 'code/shitcode/valtos/icons/rospilovo/structure.dmi'
	icon_state = "fence1"
	density = 1
	anchored = 1
	flags_1 = CONDUCT_1
...
/obj/structure/grille/rospilovo/beton
	name = "бетонный забор"
	icon = 'code/shitcode/valtos/icons/rospilovo/beton_zabor.dmi'
...
/obj/structure/grille/rospilovo/beton/green
	name = "забор"
	icon = 'code/shitcode/valtos/icons/rospilovo/green_zabor.dmi'
...
/obj/effect/step_trigger/r3b0lut10n/deathtrap/Trigger(mob/M)
	if(M.client)
		...
		M.playsound_local(T, 'code/shitcode/valtos/sounds/wrongdoorbuddy.ogg', 100, 0)
		spawn(400)
			to_chat(M, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
			to_chat(M, "<span class='info'>[message]</span>")
