...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'code/shitcode/valtos/sounds/bloodsucker/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/antagonist/bloodsucker/proc/update_bloodsucker_icons_added(datum/mind/m)
	...
	owner.current.hud_list[ANTAG_HUD].icon = image('code/shitcode/valtos/icons/bloodsucker/fulphud.dmi', owner.current, "bloodsucker")	// FULP ADDITION! Check prepare_huds in mob.dm to see why.
...
/obj/screen/bloodsucker/blood_counter		// NOTE: Look up /obj/screen/devil/soul_counter  in _onclick / hud / human.dm
	icon = 'code/shitcode/valtos/icons/bloodsucker/fulpicons.dmi'//'icons/mob/screen_gen.dmi'
	name = "Blood Consumed"
