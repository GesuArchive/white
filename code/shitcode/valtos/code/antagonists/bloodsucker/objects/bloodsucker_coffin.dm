...
/obj/structure/closet/crate/coffin/blackcoffin // closet.dmi, closets.dm, and job_closets.dm
	...
	open_sound = 'code/shitcode/valtos/sounds/bloodsucker/coffin_open.ogg'//'sound/machines/door_open.ogg'
	close_sound = 'code/shitcode/valtos/sounds/bloodsucker/coffin_close.ogg'//'sound/machines/door_close.ogg'
	breakout_time = 600
	pryLidTimer = 400
