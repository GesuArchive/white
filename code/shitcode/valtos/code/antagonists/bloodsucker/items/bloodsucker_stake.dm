...
/obj/item/stake/
	...
	icon = 'code/shitcode/valtos/icons/bloodsucker/fulpitems.dmi'
	icon_state = "wood" // Inventory Icon
	inhand_icon_state = "wood" // In-hand Icon
	lefthand_file = 'code/shitcode/valtos/icons/bloodsucker/fulpitems_hold_left.dmi' // File for in-hand icon
	righthand_file = 'code/shitcode/valtos/icons/bloodsucker/fulpitems_hold_right.dmi'
