...
/mob/living/carbon/human/proc/ReturnVampExamine(var/mob/viewer)
	...
	if (viewer.mind.has_antag_datum(ANTAG_DATUM_VASSAL) in bloodsuckerdatum.vassals)
		...
		var/returnIcon = "[icon2html('code/shitcode/valtos/icons/bloodsucker/fulpicons_small.dmi', world, "bloodsucker")]"
		returnString += "\n"
...
/mob/living/carbon/human/proc/ReturnVassalExamine(var/mob/viewer)
	...
	if (vassaldatum.master.owner == viewer.mind)
		...
		returnIcon = "[icon2html('code/shitcode/valtos/icons/bloodsucker/fulpicons_small.dmi', world, "vassal")]"
	// Am I someone ELSE'S Vassal?
		...
		returnIcon = "[icon2html('code/shitcode/valtos/icons/bloodsucker/fulpicons_small.dmi', world, "vassal_grey")]"
