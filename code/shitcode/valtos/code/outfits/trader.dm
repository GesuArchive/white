/datum/outfit/job/trader
	...
	backpack_contents = list(/obj/item/modular_computer/tablet/preset/advanced=1, /obj/item/construction/rcd/arcd=1, /obj/item/ammo_box/magazine/pistolm9mm=4, /obj/item/card/id/departmental_budget/tra)
