...
/obj/item/gangtool
	...
	icon = 'code/shitcode/valtos/icons/device.dmi'
	icon_state = "gangtool"
...
/obj/item/gangtool/hell_march/vigilante/proc/Destroy_Contraband(mob/living/user)
	...
	switch(I.type)
		...
		if(/obj/item/implanter/gang)
			value = 12
		if(/obj/item/reagent_containers/hypospray/medipen/stimulants)
			var/obj/item/reagent_containers/hypospray/medipen/stimulants/S
