...
/turf/closed/wall/brick
	...
	icon = 'code/shitcode/valtos/icons/prison/brick_wall.dmi'
	icon_state = "brick"
	hardness = 4500
	explosion_block = 5
...
/turf/open/floor/plating/asteroid/dirty
	name = "земля"
	desc = "Мягенькая."
	icon = 'code/shitcode/valtos/icons/prison/prison.dmi'
...
/turf/open/floor/trot
	...
	icon = 'code/shitcode/valtos/icons/prison/beton.dmi'
...
/obj/machinery/door/airlock/prison
	name = "дверь"
	icon = 'code/shitcode/valtos/icons/prison/doors.dmi'
...
/obj/machinery/door/poddoor/shutters/prison/update_icon()
	if(density)
		playsound(src, 'code/shitcode/valtos/sounds/prison/close.ogg', 20, 1)
		icon_state = "closed"
	else
		playsound(src, 'code/shitcode/valtos/sounds/prison/open.ogg', 20, 1)
		icon_state = "open"
...
/obj/structure/sign/prison/tablo
	name = "табло"
	icon = 'code/shitcode/valtos/icons/prison/prisonw.dmi'
	desc = "Табличка. Кусь."
	icon_state = "t1"
...
/obj/machinery/power/port_gen/pacman/coal
	...
	icon = 'code/shitcode/valtos/icons/prison/prisond.dmi'
...
/obj/structure/chair/prison/wood
	...
	icon = 'code/shitcode/valtos/icons/prison/decor.dmi'
	icon_state = "chair"
	item_chair = null
...
/obj/machinery/light/streetlight
	name = "уличная лампа"
	icon = 'code/shitcode/valtos/icons/prison/prisonh.dmi'
	base_state = "light"
	icon_state = "light1"
	brightness = 10
	layer = 5
