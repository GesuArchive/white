/mob/living/simple_animal/pig
	...
	maxHealth = 50
	health = 50
	attacked_sound = 'code/shitcode/valtos/sounds/pig/oink.ogg'
	deathsound = 'code/shitcode/valtos/sounds/pig/death.ogg'
...
/mob/living/simple_animal/pig/Life()
	...
	if(stat)
		return
	if(prob(10))
		var/chosen_sound = pick('code/shitcode/valtos/sounds/pig/hru.ogg', 'code/shitcode/valtos/sounds/pig/oink.ogg', 'code/shitcode/valtos/sounds/pig/squeak.ogg')
		playsound(src, chosen_sound, 50, TRUE)

/obj/item/reagent_containers/food/snacks/meat/slab/pig
	name = "сало"
	icon = 'code/shitcode/valtos/icons/items.dmi'
	icon_state = "salo"
