...
/obj/machinery/mailbox
	name = "mailbox"
	desc = "ѕочтовый €щик, который позвол€ет обмениватьс€ товарами между станци€ми. ѕринимает только специальные контейнеры."
...
/obj/item/storage/box/mailbox
	name = "box MK1"
	desc = "—пециальна€ коробка, которую не порвЄт даже при сверхвысоком блюспейс давлении. —охранность товаров внутри не гарантируетс€."
	resistance_flags = LAVA_PROOF | FIRE_PROOF | UNACIDABLE | ACID_PROOF
