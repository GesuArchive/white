...
/datum/round_aspect/rich
	name = "Rich"
	desc = "Ёкипаж работал усердно в прошлую смену, за что и был награждЄн преми€ми в размере 5000 кредитов каждому."
	weight = 9
...
/datum/round_aspect/drunk
	name = "Drunk"
	desc = "Ќа станции стоит €вный запах вчерашнего весель€... и кажетс€ оно только начинаетс€."
	weight = 11
