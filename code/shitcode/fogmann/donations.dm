...
GLOBAL_LIST_INIT(donations_list, list(
	"Hats" = list(
		...
		new /datum/donate_info("Arbiter Helmet",			/obj/item/clothing/head/helmet/arbiter,			215),
		new /datum/donate_info("Inquisitor Helmet",			/obj/item/clothing/head/helmet/arbiter/inquisitor,255),
		new /datum/donate_info("m35 Cap",					/obj/item/clothing/head/helmet/izanhelm,		120),
		new /datum/donate_info("m35 Elite Cap",				/obj/item/clothing/head/helmet/izanhelm/elite,	150),
		new /datum/donate_info("m35 Helmet",				/obj/item/clothing/head/helmet/izanhelm/helmet,	120),
		new /datum/donate_info("m35 Elite Helmet",			/obj/item/clothing/head/helmet/izanhelm/helmet/elite,150),
		new /datum/donate_info("Pickelhelm",				/obj/item/clothing/head/helmet/izanhelm/helmet/pickelhelm,250),
		new /datum/donate_info("Richard's Head",			/obj/item/clothing/head/helmet/richard,			350),
	),
	"Masks" = list(
	...
	"Shoes" = list(
		...
		new /datum/donate_info("Arbiter Boots",				/obj/item/clothing/shoes/jackboots/arbiter,		200),
	),
	"Coats" = list(
		...
		new /datum/donate_info("Arbiter Vest",				/obj/item/clothing/suit/armor/vest/izan/arbiter,200),
		new /datum/donate_info("m35 Coat",					/obj/item/clothing/suit/armor/vest/izan/army_coat,120),
		new /datum/donate_info("m35 Elite Coat",			/obj/item/clothing/suit/armor/vest/izan/elite_army_coat,165),
		new /datum/donate_info("m35 Super Elite Coat",		/obj/item/clothing/suit/armor/vest/izan/super_elite_army_coat,200),
	),
	"Jumpsuits" = list(
		...
		new /datum/donate_info("m35 Elite Jacket",			/obj/item/clothing/under/m35jacket/elite,		165),
		new /datum/donate_info("m35 Super Elite Jacket",	/obj/item/clothing/under/m35jacket/elite/super,	200),
		new /datum/donate_info("Magistrate Uniform",		/obj/item/clothing/under/magistrate,			200),
		new /datum/donate_info("Arbiter Uniform",			/obj/item/clothing/under/arbiter,				200),
	),
	"Gloves" = list(
		...
		new /datum/donate_info("Arbiter Gloves",			/obj/item/clothing/gloves/arbiter,				150),
		new /datum/donate_info("Undertaker Gloves",			/obj/item/clothing/gloves/arbiter/undertaker,	165),
	),
	"Bedsheets" = list(
