...
#define PICK_WATER_WADE_NOISES pick('white/valtos/sounds/liquid/water_wade1.ogg', 'white/valtos/sounds/liquid/water_wade2.ogg', 'white/valtos/sounds/liquid/water_wade3.ogg', 'white/valtos/sounds/liquid/water_wade4.ogg')
