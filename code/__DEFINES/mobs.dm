...
//Humans get thirsty
#define HYDRATION_LEVEL_OVERHYDRATED 40
#define HYDRATION_LEVEL_NORMAL 20
#define HYDRATION_LEVEL_THIRSTY 10
#define HYDRATION_LEVEL_DEHYDRATED 0
#define HYDRATION_LEVEL_START_MIN 25
#define HYDRATION_LEVEL_START_MAX 35
#define HYDRATION_LOSS_PER_LIFE 0.04
#define DRINK_HYDRATION_FACTOR 0.25
