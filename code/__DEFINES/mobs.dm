...
//Humans get thirsty
#define THIRST_LEVEL_OVERHYDRATED 40
#define THIRST_LEVEL_NORMAL 20
#define THIRST_LEVEL_THIRSTY 10
#define THIRST_LEVEL_DEHYDRATED 0
#define THIRST_LEVEL_START_MIN 25
#define THIRST_LEVEL_START_MAX 35
#define THIRST_LOSS_PER_LIFE 0.04
#define DRINK_THIRST_FACTOR 2.5
#define THIRST_STUTTER_RATE 15
...
#define DEFIB_FAIL_HELLBOUND (1<<9)
