...
#define	HUNGER_FACTOR		0.48	//factor at which mob nutrition decreases //H_WEEK
#define	ETHEREAL_CHARGE_FACTOR	0.44 //factor at which ethereal's charge decreases
