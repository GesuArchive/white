...
#define MAX_S_TURF SMOOTH_GROUP_IRIDIUM_WALLS //Always match this value with the one above it.
...
#define SMOOTH_GROUP_BLUESPACE_OPENSPACE S_OBJ(70)					///turf/open/openspace/bluespace
