...
#define ACCESS_BRIG_SPECIALIST 702
...
#define PDA_PAINTING_REGIONS list( \
	...
	/obj/item/modular_computer/tablet/pda/hunter = list(REGION_SUPPLY), \
	/obj/item/modular_computer/tablet/pda/exploration = list(REGION_SUPPLY, REGION_RESEARCH), \
