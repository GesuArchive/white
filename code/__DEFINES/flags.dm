...
#define RAD_PROTECT_CONTENTS_1 (1<<10)
/// should this object be allowed to be contaminated
#define RAD_NO_CONTAMINATE_1 (1<<11)
/// Should this object be paintable with very dark colors?
#define ALLOW_DARK_PAINTS_1 (1<<12)
/// Should this object be unpaintable?
#define UNPAINTABLE_1 (1<<13)
/// Is the thing currently spinning?
#define IS_SPINNING_1 (1<<14)
#define IS_ONTOP_1 (1<<15)
#define SUPERMATTER_IGNORES_1 (1<<16)
/// If a turf can be made dirty at roundstart. This is also used in areas.
#define CAN_BE_DIRTY_1 (1<<17)
/// Should we use the initial icon for display? Mostly used by overlay only objects
#define HTML_USE_INITAL_ICON_1 (1<<18)
/// Can players recolor this in-game via vendors (and maybe more if support is added)?
#define IS_PLAYER_COLORABLE_1 (1<<19)
#define KEEP_ON_ARENA_1 (1<<20)
/// Whether or not this atom has contextual screentips when hovered OVER
#define HAS_CONTEXTUAL_SCREENTIPS_1 (1<<21)
/// Whether or not this atom is storing contents for a disassociated storage object
#define HAS_DISASSOCIATED_STORAGE_1 (1<<22)
...
#define DECAL_INIT_UPDATE_EXPERIENCED_1 (1<<23)
...
#define ZAP_TESLA_FLAGS ZAP_DEFAULT_FLAGS | ZAP_GENERATES_POWER
