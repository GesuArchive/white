...
#define ADMIN_FLW(user) "\[<a href='?_src_=holder;[HrefToken(TRUE)];adminplayerobservefollow=[REF(user)]'>FL</a>\]"
...
#define ADMIN_KICK(user) "\[<a href='?_src_=holder;[HrefToken(TRUE)];boot2=[REF(user)]'>KI</a>\]"
#define ADMIN_CENTCOM_REPLY(user) "\[<a href='?_src_=holder;[HrefToken(TRUE)];CentComReply=[REF(user)]'>RY</a>\]"
#define ADMIN_SYNDICATE_REPLY(user) "\[<a href='?_src_=holder;[HrefToken(TRUE)];SyndicateReply=[REF(user)]'>RY</a>\]"
...
#define ADMIN_SMITE(user) "\[<a href='?_src_=holder;[HrefToken(TRUE)];adminsmite=[REF(user)]'>SE</a>\]"
