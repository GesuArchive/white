...
#define OVERMIND_MAX_POINTS_DEFAULT                 70          // Max point storage
#define OVERMIND_STARTING_POINTS                    70          // Points granted upon start
...
#define OVERMIND_WIN_CONDITION_AMOUNT               1000        // Blob structures required to win
...
#define BLOB_CORE_MAX_HP                            600
#define BLOB_CORE_HP_REGEN                          4           // Bases health regeneration rate every process(), can be added on by strains
...
#define BLOB_CORE_MAX_SPORES                        7           // Spores that the core can produce for free

#define BLOB_NODE_MAX_HP                            100
...
#define BLOB_NODE_MAX_SPORES                        3           // Spores that nodes can maintain

#define BLOB_FACTORY_MAX_HP                         100
#define BLOB_FACTORY_HP_REGEN                       1
#define BLOB_FACTORY_MIN_DISTANCE                   7           // Minimum distance between factories
#define BLOB_FACTORY_MAX_SPORES                     10
...
#define BLOB_REGULAR_MAX_HP                         10
#define BLOB_REGULAR_HP_REGEN                       3           // Health regenerated when pulsed by a node/core

#define BLOB_STRONG_MAX_HP                          50
#define BLOB_STRONG_HP_REGEN                        7

#define BLOB_REFLECTOR_MAX_HP                       50
#define BLOB_REFLECTOR_HP_REGEN                     7
...
#define BLOB_STRUCTURE_RESOURCE_COST                30
#define BLOB_STRUCTURE_FACTORY_COST                 40
#define BLOB_STRUCTURE_NODE_COST                    40

#define BLOB_REFUND_STRONG_COST                     2           // Points refunded when destroying the structure
#define BLOB_REFUND_REFLECTOR_COST                  4
#define BLOB_REFUND_FACTORY_COST                    15
#define BLOB_REFUND_NODE_COST                       15

// Blob power properties

#define BLOB_POWER_RELOCATE_COST                    70          // Resource cost to move your core to a different node
#define BLOB_POWER_REROLL_COST                      70          // Strain reroll
...
#define BLOBMOB_HEALING_MULTIPLIER                  0.125      // Multiplies by -maxHealth and heals the blob by this amount every blob_act
#define BLOBMOB_SPORE_HEALTH                        10          // Base spore health
#define BLOBMOB_SPORE_SPAWN_COOLDOWN                1 SECONDS
#define BLOBMOB_SPORE_DMG_LOWER                     1
#define BLOBMOB_SPORE_DMG_UPPER                     2
#define BLOBMOB_BLOBBERNAUT_RESOURCE_COST           10          // Purchase price for making a blobbernaut
#define BLOBMOB_BLOBBERNAUT_HEALTH                  50         // Base blobbernaut health
#define BLOBMOB_BLOBBERNAUT_DMG_SOLO_LOWER          5          // Damage without active overmind (core dead or xenobio mob)
#define BLOBMOB_BLOBBERNAUT_DMG_SOLO_UPPER          10
#define BLOBMOB_BLOBBERNAUT_DMG_LOWER               2           // Damage dealt with active overmind (most damage comes from strain chems)
#define BLOBMOB_BLOBBERNAUT_DMG_UPPER               4
#define BLOBMOB_BLOBBERNAUT_REAGENTATK_VOL          10          // Amounts of strain reagents applied on attack -- basically the main damage stat
#define BLOBMOB_BLOBBERNAUT_DMG_OBJ                 30          // Damage dealth to objects/machines
