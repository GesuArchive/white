...
#define PAYCHECK_PRISONER 500
#define PAYCHECK_ASSISTANT 100
#define PAYCHECK_MINIMAL 1500
#define PAYCHECK_EASY 2000
#define PAYCHECK_MEDIUM 3000
#define PAYCHECK_HARD 5000
#define PAYCHECK_COMMAND 7000
