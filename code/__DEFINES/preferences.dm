...
#define CHAT_SPAM			(1<<14)

#define TOGGLES_DEFAULT_CHAT (CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_GHOSTSIGHT|CHAT_PRAYER|CHAT_RADIO|CHAT_PULLR|CHAT_GHOSTWHISPER|CHAT_GHOSTPDA|CHAT_GHOSTRADIO|CHAT_BANKCARD|CHAT_LOOC|CHAT_GHOSTLAWS|CHAT_LOGIN_LOGOUT)
...
#define W_TOGGLES_DEFAULT (SOUND_JUKEBOX)
