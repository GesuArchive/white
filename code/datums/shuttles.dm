...
/datum/map_template/shuttle/emergency/construction
	...
	description = "Для предпиимчевого челночного инженера! Шасси будет пристыковано при покупке, но запуск должен быть разрешен в обычном порядке через вызов шатла. Поставляется вместе со строительными материалами. Разблокирует возможность купить ящики с двигателем шатла в отделе снабжения."
