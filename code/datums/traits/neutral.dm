...
/datum/quirk/foreigner
	...
	value = 0
	gain_text = "<span class='notice'>Не понимаю ни слова.</span>"
	lose_text = "<span class='notice'>Удалось начать понимать основной галактический язык.</span>"
...
/datum/quirk/deviant_tastes
	...
	value = 0
	gain_text = "<span class='notice'>У меня возникает жажда съесть что-нибудь странное на вкус.</span>"
...
/datum/quirk/needswayfinder/post_add()
	...
	to_chat(quirk_holder, "<span class='notice'>У вас с собой указатель [where], который поможет мне найти путь в какой-либо отсек. Нажми в руке, чтобы активировать.</span>")
