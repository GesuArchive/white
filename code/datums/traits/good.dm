...
/datum/quirk/alcohol_tolerance
	...
	desc = "Вы пьянеете медленнее и на вас меньше действует алкоголь."
	value = 4
...
/datum/quirk/drunkhealing
	...
	desc = "Ничего, кроме очередной хорошей выпивки не будет придавать вам чувство, что вы находитесь на вершине мира. Когда вы пьяны, то медленно будете регенерировать повреждения."
	value = 8
...
/datum/quirk/empath
	name = "Эмпатия"
	desc = "Или шестое чувство, или просто тщательное изучение языка тела, но вам просто будет достаточно взгляда на кого-нибудь, чтобы понять, как он себя чувствует."
	value = 8
...
/datum/quirk/fan_clown
	name = "Фанат клоунов"
	desc = "Вас веселят клоуны. Ваше настроение повышается, если вы носите на груди значок с их изображением."
	value = 2
...
/datum/quirk/fan_mime
	name = "Фанат мимов"
	desc = "Вам нравится мимы. Ваше настроение повышается, если вы носите на груди значок с их изображением."
	value = 2
...
/datum/quirk/freerunning
	name = "Паркурист"
	desc = "Вы будете быстрее забираться на столы, а также будете получать сниженный урон от падения."
	value = 8
...
/datum/quirk/friendly
	name = "Дружелюбный"
	desc = "Вы будете хорошо обниматься, особенно когда у вас хорошее настроение."
	value = 4
...
/datum/quirk/light_step
	name = "Легкий шаг"
	desc = "Вы будете уметь ходить аккуратно; будете тише наступать на осколки, а наносимый урон от этого будет меньше. Также не оставляете после себя следов."
	value = 4
...
/datum/quirk/musician
	name = "Музыкант"
	desc = "Вы сможете настраивать музыкальные инструменты таким образом, что мелодия будет снимать определенные негативные эффекты у окружающих и успокаивать душу."
	value = 2
...
/datum/quirk/night_vision
	name = "Ночное видение"
	desc = "Вы будете видеть в темноте немного лучше."
	value = 4
...
/datum/quirk/selfaware
	name = "Самоконтроль"
	desc = "Вы сможете точно оценить степень нанесенных вам повреждений."
	value = 8
...
/datum/quirk/spiritual
	name = "Религиозный"
	desc = "Шанс, что ваши молитвы будут услышаны, будет немного увеличен. Возможно."
	value = 4
...
/datum/quirk/tagger
	name = "Граффер"
	desc = "В прошлом вам довольно часто доводилось заниматься рисованием граффити. Будете экономно расходовать количество использований вашего баллончика."
	value = 4
...
/datum/quirk/voracious
	name = "Прожорливый"
	desc = "Ничего не встает на пути между вами и едой. Будете есть в два раза быстрее и вполне сможете перекусить нездоровой для вас пищей. Быть толстым вам очень подходит."
	value = 4
