...
/datum/martial_art/proc/basic_hit(mob/living/carbon/human/A,mob/living/carbon/human/D)
	...
	if(!damage)
		...
		D.visible_message("<span class='warning'>[A] [atk_verb] мимо [D]!</span>", \
			"<span class='userdanger'>[A] [atk_verb] мимо тебя!</span>", null, COMBAT_MESSAGE_RANGE)
	...
	D.visible_message("<span class='danger'>[A] [atk_verb] [D]!</span>", \
			"<span class='userdanger'>[A] [atk_verb] тебя!</span>", null, COMBAT_MESSAGE_RANGE)
	...
	if((D.stat != DEAD) && damage >= A.dna.species.punchstunthreshold)
		D.visible_message("<span class='danger'>[A] валит [D] на пол!!</span>", \
								"<span class='userdanger'>[A] валит тебя на пол!</span>")
