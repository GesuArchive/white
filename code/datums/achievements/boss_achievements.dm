...
/datum/award/achievement/boss/legion_kill
	name = "Погибель Легиона"
	desc = "Нас было много... теперь нас нет."
