...
/datum/element/selfknockback/proc/Item_SelfKnockback(obj/item/I, atom/attacktarget, mob/usertarget, proximity_flag)
	...
	if(proximity_flag || (get_dist(attacktarget, usertarget) <= I.reach))
		...
		usertarget.visible_message("<span class='warning'>[usertarget] gets thrown back by the force of [I] impacting [attacktarget]!</span>", "<span class='warning'>The force of [I] impacting [attacktarget] sends you flying!</span>")
