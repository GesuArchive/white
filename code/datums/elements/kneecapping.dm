...
/datum/element/kneecapping/proc/do_kneecap_target(obj/item/weapon, obj/item/bodypart/leg, mob/living/carbon/target, mob/attacker)
	...
	attacker.visible_message(span_warning("[attacker] carefully aims [attacker.p_their()] [weapon] for a swing at [target]'s kneecaps!"), span_danger("You carefully aim <b>[weapon]</b> for a swing at [target]'s kneecaps!"))
	...
	if(do_mob(attacker, target, 3 SECONDS, interaction_key = weapon))
		attacker.visible_message(span_warning("[attacker] swings [attacker.p_their()] [weapon] at [target]'s kneecaps!"), span_danger("You swing <b>[weapon]</b> at [target]'s kneecaps!"))
