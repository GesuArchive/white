...
/datum/mutation/human/space_adaptation
	...
	quality = POSITIVE
	difficulty = 16
	text_gain_indication = "<span class='notice'>Ощущаю некое родство с окружающей нас пустотой космоса! Так и хочется выйти из шлюза, протянуть к нему руку, снять шлем и ...</span>"
	instability = 30
