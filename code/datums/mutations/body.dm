...
/datum/mutation/human/martyrdom
	...
	desc = "Мутация которая вызывает коллапсирующую клеточную дестабилизацию если организм носителя близок к смерти. Это не наносит урона, но очень, ОЧЕНЬ сильно дезориентирует!"
	locked = TRUE
