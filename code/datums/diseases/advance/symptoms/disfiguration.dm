...
/datum/symptom/disfiguration/Activate(datum/disease/advance/A)
	...
	switch(A.stage)
		if(5)
			...
			M.visible_message("<span class='warning'>[M] face appears to cave in!</span>", "<span class='notice'>You feel your face crumple and cave in!</span>")
		else
			M.visible_message("<span class='warning'>[M] face begins to contort...</span>", "<span class='notice'>Your face feels wet and malleable...</span>")
