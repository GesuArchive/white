...
/datum/disease/parasite/stage_act()
	...
	if(!affected_liver)
		affected_mob.visible_message("<span class='notice'><B>[affected_mob] liver is covered in tiny larva! They quickly shrivel and die after being exposed to the open air.</B></span>")
		cure()
		return FALSE
