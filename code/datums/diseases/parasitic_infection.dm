...
/datum/disease/parasite/stage_act(delta_time, times_fired)
	...
	if(!affected_liver)
		affected_mob.visible_message(span_notice("<B>[affected_mob] liver is covered in tiny larva! They quickly shrivel and die after being exposed to the open air.</B>"))
		cure()
		return FALSE
