	...
	if(!D.stat && !D.IsParalyzed())
		if(A.dir != D.dir)
			...
			D.visible_message("<span class='warning'><b>[A]</b> пытается ударить <b>[D]</b> в спину, но промахивается!</span>", \
						"<span class='userdanger'><b>[A]</b> пытается ударить тебя в спину, но промахивается!</span>")
			return TRUE
		log_combat(A, D, "back-kicked (Sleeping Carp)")
		A.do_attack_animation(D, ATTACK_EFFECT_PUNCH)
		D.visible_message("<span class='warning'><b>[A]</b> пинает <b>[D]</b> в спину!</span>", \
					"<span class='userdanger'><b>[A]</b> пинает тебя в спину, принуждая тебя упасть!</span>")
...
/datum/martial_art/the_sleeping_carp/proc/kneeStomach(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsParalyzed())
		...
		D.visible_message("<span class='warning'><b>[A]</b> бьёт <b>[D]</b> коленом в живот!</span>", \
						  "<span class='userdanger'><b>[A]</b> бьёт тебя коленом в живот!</span>")
		D.audible_message("<b>[D]</b> задыхается!")
		D.losebreath += 3
		D.Stun(40)
		playsound(get_turf(D), 'sound/weapons/punch1.ogg', 50, TRUE, -1)
		return TRUE
...
/datum/martial_art/the_sleeping_carp/proc/headKick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsParalyzed())
		...
		D.visible_message("<span class='warning'><b>[A]</b> пинает <b>[D]</b> в голову!</span>", \
						  "<span class='userdanger'><b>[A]</b> пинает тебя в ебало!</span>")
...
/datum/martial_art/the_sleeping_carp/proc/elbowDrop(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!(D.mobility_flags & MOBILITY_STAND))
		...
		D.visible_message("<span class='warning'><b>[A]</b> кидает <b>[D]</b> с прогиба!</span>", \
							"<span class='userdanger'><b>[A]</b> кидает тебя с прогиба!</span>")
		if(D.stat)
			D.death() //FINISH HIM!
	...
	if(A.a_intent == INTENT_GRAB && A!=D) // A!=D prevents grabbing yourself
		...
		if(old_grab_state == GRAB_PASSIVE)
			...
			D.visible_message("<span class='warning'><b>[A]</b> жестко хватает <b>[D]</b>!</span>", \
								"<span class='userdanger'><b>[A]</b> жестко хватает тебя!</span>")
		return TRUE
	return FALSE
...
/datum/martial_art/the_sleeping_carp/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message("<span class='danger'><b>[A]</b> [atk_verb] <b>[D]</b>!</span>", \
					  "<span class='userdanger'><b>[A]</b> [atk_verb] тебя!</span>")
