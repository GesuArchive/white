...
/datum/martial_art/wrestling/proc/throw_wrassle(mob/living/A, mob/living/D)
	...
	if (A && D)
		...
		D.visible_message("<span class='danger'>[A] throws [D]!</span>", \
						"<span class='userdanger'>You're thrown by [A]!</span>", "<span class='hear'>Слышу агрессивную потасовку и громкий стук!</span>", null, A)
...
/datum/martial_art/wrestling/proc/slam(mob/living/A, mob/living/D)
	...
	D.visible_message("<span class='danger'>[A] lifts [D] up!</span>", \
					"<span class='userdanger'>You're lifted up by [A]!</span>", "<span class='hear'>Слышу агрессивную потасовку!</span>", null, A)
	...
	if (A && D)
		...
		D.visible_message("<span class='danger'>[A] [fluff] [D]!</span>", \
						"<span class='userdanger'>You're [fluff]ed by [A]!</span>", "<span class='hear'>Слышу звук разрывающейся плоти!</span>", COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/wrestling/proc/strike(mob/living/A, mob/living/D)
	...
	if (T && isturf(T) && D && isturf(D.loc))
		...
		D.visible_message("<span class='danger'>[A] headbutts [D]!</span>", \
						"<span class='userdanger'>You're headbutted by [A]!</span>", "<span class='hear'>Слышу звук разрывающейся плоти!</span>", COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/wrestling/proc/kick(mob/living/A, mob/living/D)
	...
	D.visible_message("<span class='danger'>[A] roundhouse-kicks [D]!</span>", \
					"<span class='userdanger'>You're roundhouse-kicked by [A]!</span>", "<span class='hear'>Слышу звук разрывающейся плоти!</span>", COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/wrestling/grab_act(mob/living/A, mob/living/D)
	...
	D.visible_message("<span class='danger'>[A] gets [D] in a cinch!</span>", \
					"<span class='userdanger'>You're put into a cinch by [A]!</span>", "<span class='hear'>Слышу агрессивную потасовку!</span>", COMBAT_MESSAGE_RANGE, A)
