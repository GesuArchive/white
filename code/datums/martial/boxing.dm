...
/datum/martial_art/boxing/harm_act(mob/living/A, mob/living/D)
	...
	if(!damage)
		...
		D.visible_message("<span class='warning'>[A] бьёт [atk_verb] мимо [D]!</span>" , \
			"<span class='userdanger'>[A] бьёт [atk_verb] мимо меня!</span>" , "<span class='hear'>Слышу взмах!</span>" , COMBAT_MESSAGE_RANGE, A)
