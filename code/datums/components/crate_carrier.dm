...
/datum/component/crate_carrier/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_LIVING_UNARMED_ATTACK, .proc/on_unarm_attack)
...
/datum/component/crate_carrier/proc/on_examine(mob/living/source, mob/examiner, list/examine_list)
	...
	if(num_crates > 0)
		examine_list += "<span class='notice'>[source.p_theyre(TRUE)] carrying [num_crates == 1 ? "a crate":"[num_crates] crates"].</span>"
