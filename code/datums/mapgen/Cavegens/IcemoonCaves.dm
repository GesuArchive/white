/datum/map_generator/cave_generator/icemoon
	weighted_open_turf_types =  list(
		/turf/open/floor/plating/asteroid/snow/icemoon = 19,
		/turf/open/floor/plating/ice/icemoon = 1
	)
...
/datum/map_generator/cave_generator/icemoon/deep
	weighted_closed_turf_types = list(
		/turf/closed/mineral/random/snow/underground = 1
	)
	...
	weighted_mob_spawn_list = list(
		...
		/mob/living/simple_animal/hostile/asteroid/hivelord/legion/snow = 50,
		/obj/structure/spawner/ice_moon/demonic_portal/snowlegion = 3
	)

	weighted_flora_spawn_list = list(
		/obj/structure/flora/rock/icy = 6,
		/obj/structure/flora/rock/pile/icy = 6,
