/datum/map_generator/forest_generator
	...
	BIOME_LOW_HEAT = list(
		...
		BIOME_LOWMEDIUM_HUMIDITY = /datum/biome/mudlands/normal,
		BIOME_HIGHMEDIUM_HUMIDITY = /datum/biome/mudlands/normal,
		BIOME_HIGH_HUMIDITY = /datum/biome/water/normal
		),
	BIOME_LOWMEDIUM_HEAT = list(
		BIOME_LOW_HUMIDITY = /datum/biome/plains/normal,
		BIOME_LOWMEDIUM_HUMIDITY = /datum/biome/jungle/normal,
		BIOME_HIGHMEDIUM_HUMIDITY = /datum/biome/jungle/normal,
		BIOME_HIGH_HUMIDITY = /datum/biome/mudlands/normal
		),
...
/datum/map_generator/forest_generator/generate_terrain(list/turfs)
	. = ..()
	...
	for(var/t in turfs) //Go through all the turfs and generate them
		...
		if(height <= 0.85) //If height is less than 0.85, we generate biomes based on the heat and humidity of the area.
			...
			selected_biome = /datum/biome/jungle/normal/deep
