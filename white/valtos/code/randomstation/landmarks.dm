...
/obj/effect/landmark/stationroom/engine/random
	//template_names = list("Supermatter Engine" = 8, "Particle Accelerator Engine" = 10, "Antimatter Engine" = 8, "Budget Engine" = 1, "TEG Engine" = 7)
	template_names = list(
		//"Antimatter Engine" = 1,
		//"Budget Engine" = 1,
		//"Particle Accelerator Engine" = 1,
		//"Supermatter Engine" = 1,
		"TEG Engine" = 0,
	)
	icon_state = "engine_template"
