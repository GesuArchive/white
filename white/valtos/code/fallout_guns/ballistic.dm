...
/obj/item/gun/ballistic/automatic/fallout/minigun
	...
	fire_sound = 'white/valtos/sounds/fallout/10mm_fire_03.ogg'
	fire_delay = 0.2
...
/obj/item/gun/ballistic/automatic/fallout/shotgun/pancor
	...
	fire_sound = 'white/valtos/sounds/fallout/repeater_fire.ogg'
...
/obj/item/gun/ballistic/automatic/fallout/bozar
	...
	w_class = WEIGHT_CLASS_HUGE
	weapon_weight = WEAPON_HEAVY
	fire_sound = 'white/valtos/sounds/fallout/bozar_fire.ogg'
	zoomable = TRUE
	zoom_amt = 10
	zoom_out_amt = 13
 ...
 /obj/item/gun/ballistic/automatic/fallout/m72
	...
	icon = 'white/valtos/icons/fallout/projectile.dmi'
	item_state = "shotgun"
	slot_flags = ITEM_SLOT_BACK
	mag_type = /obj/item/ammo_box/magazine/m2mm
	fire_sound = 'white/valtos/sounds/fallout/gauss_rifle.ogg'
	can_suppress = FALSE
	fire_delay = 3
	zoomable = TRUE
	zoom_amt = 10
...
/obj/item/gun/ballistic/automatic/fallout/lsw
	...
	fire_sound = 'white/valtos/sounds/fallout/assaultrifle_fire.ogg'
	can_suppress = FALSE
	fire_delay = 0.3
	w_class = WEIGHT_CLASS_HUGE
	weapon_weight = WEAPON_HEAVY */
