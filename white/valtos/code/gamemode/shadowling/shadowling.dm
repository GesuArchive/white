...
/datum/game_mode/proc/replace_jobbaned_player(mob/living/M, role_type, pref)
	var/list/mob/dead/observer/candidates = poll_candidates_for_mob("Do you want to play as a [role_type]?", "[role_type]", null, 50, M)
...
/datum/species/shadow/ling
	...
	inherent_traits = list(TRAIT_CAN_STRIP,TRAIT_NOGUNS, TRAIT_RESISTCOLD, TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE, TRAIT_NOBREATH, TRAIT_RADIMMUNE, TRAIT_VIRUSIMMUNE, TRAIT_PIERCEIMMUNE)
...
/datum/species/shadow/ling/lesser //Empowered thralls. Obvious, but powerful
	...
	inherent_traits = list(TRAIT_NOBREATH, TRAIT_RADIMMUNE, TRAIT_CAN_STRIP)
	burnmod = 1.1
	heatmod = 1.1
