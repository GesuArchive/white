/client/verb/mentorhelp(msg as text)
	...
	var/mentor_msg = "<span class='mentor'><b>ЗНАТОК:</b> <b>[key_name_mentor(src, 1, 0, 1, show_char)]</b>: [msg]</span>"
	...
	to_chat(src, "<span class='mentor'>Сообщение <b>Знатокам</b>: [msg]</span>")
	return
