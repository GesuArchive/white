/client/verb/mentorhelp(msg as text)
	...
	var/mentor_msg = "<span class='mentornotice'><b><font color='purple'>ЗНАТОК:</b> <b>[key_name_mentor(src, 1, 0, 1, show_char)]</b>: [msg]</font></span>"
	...
	to_chat(src, "<span class='mentornotice'><font color='purple'>Сообщение <b>Знатокам</b>: [msg]</font></span>")
	return
