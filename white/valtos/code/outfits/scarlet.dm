...
/obj/item/clothing/suit/space/x031/equipped(mob/user, slot)
	...
	spawn(10)
		if(src && user && ishuman(user))
			...
			if(H.wear_suit == src)
				INVOKE_ASYNC(src, PROC_REF(bootSequence), user)
...
/obj/item/clothing/suit/space/x031/proc/bootSequence(mob/living/carbon/human/H)
	...
	to_chat(H, span_revenboldnotice("<center> -|- ИНИЦИАЛИЗАЦИЯ #1 -|- </center>"))
	sleep(15)
	for(var/i in 1 to 10)
		to_chat(H, span_revenboldnotice("<center> -|- [md5("[rand(0, 999)][H]")] -|- </center>"))
		playsound(src, 'sound/machines/beep.ogg', 50, FALSE)
		sleep(1)
	sleep(20)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 4)
	to_chat(H, span_revenboldnotice("<center> -|- УСПЕШНАЯ ОШИБКА #1 -|- </center>"))
	sleep(5)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 3)
	to_chat(H, span_revenboldnotice("<center> -|- ПОДКЛЮЧЕНИЕ #1 -|- </center>"))
	sleep(20)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 4)
	to_chat(H, span_revenboldnotice("<center> -|- УСПЕШНАЯ ОШИБКА #2 -|- </center>"))
	sleep(5)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 3)
	to_chat(H, span_revenboldnotice("<center> -|- АДАПТАЦИЯ #1 -|- </center>"))
	sleep(10)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 4)
	to_chat(H, span_revenboldnotice("<center> -|- УСПЕШНАЯ ОШИБКА #3 -|- </center>"))
	sleep(5)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 2)
	to_chat(H, span_revenboldnotice("<center> -|- ПОДКЛЮЧЕНИЕ #2 -|- </center>"))
	for(var/i in 1 to 7)
		to_chat(H, span_revenboldnotice("<center> -|- [md5("[rand(0, 999)][H]")] -|- </center>"))
		playsound(src, 'sound/machines/beep.ogg', 50, FALSE)
		sleep(1)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 5)
	to_chat(H, span_revenboldnotice("<center> -|- КРИТИЧЕСКАЯ ОШИБКА -|- </center>"))
	sleep(20)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 6)
	to_chat(H, span_revenboldnotice("<center> -|- АДАПТАЦИЯ #2 -|- </center>"))
	sleep(20)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 4)
	to_chat(H, span_revenboldnotice("<center> -|- УСПЕХ #1 -|- </center>"))
	sleep(20)
	H.overlay_fullscreen("scarlet", /atom/movable/screen/fullscreen/scarlet, 7)
	to_chat(H, span_revenboldnotice("<center> -!- ЗАПУСК #1 -!- </center>"))
	sleep(20)
	to_chat(H, span_revenboldnotice("<center> -!- СИСТЕМА В СЕТИ #1 -!- </center>"))
