	...
	spawn(50)
		if(mind)
			switch(mind.assigned_role)
				if("Captain", "Head of Security", "Head of Personnel", "Chief Medical Officer", "Chief Engineer", "Research Director", "Veteran", "Warden", "Detective", "Russian Officer", "Security Officer", "Hacker")
					fate_luck = 4
