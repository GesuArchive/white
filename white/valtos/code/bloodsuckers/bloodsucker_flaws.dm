...
/datum/antagonist/bloodsucker/proc/AssignClanAndBane(tzimisce = FALSE)
	...
	if(tzimisce)
		...
		to_chat(owner, "<span class='announce'>As you arrive near the station, you recall all you know and why you are here.\n\
			...
			* Finally, your Favorite Vassal will turn into a battle monster to help you in combat.</span>")
		AddHumanityLost(5.6)
	...
	to_chat(owner, "<span class='announce'>List of all Clans:\n\
		Gangrel - Prone to Frenzy, strange outcomes from being on frenzy, special power.\n\
		Lasombra - Life in the shadows, very weak to fire but no brute damage, upgradable abilities through tasks.</span>")
	...
	switch(answer)
		if(CLAN_GANGREL)
			...
			to_chat(owner, "<span class='announce'>You have Ranked up enough to learn: You are part of the Gangrel Clan!\n\
				...
				* Finally, your Favorite Vassal will gain the Minor Beast Form ability to help you in combat.</span>")
		...
		if(CLAN_LASOMBRA)
			...
			to_chat(owner, "<span class='announce'>You have Ranked up enough to learn: You are part of the Lasombra Clan!\n\
				...
				* Finally, your Favorite Vassal will gain the Lesser Glare and Shadow Walk abilities to help you in combat.</span>")
			...
			to_chat(owner, "<span class='notice'>You have also learned how to channel the abyss's power into an iron knight's armor that can be build in the structure ta and activated as a trap for your lair.</span>")
