...
/datum/gear/footwear/laceup
	display_name = "шнуровочные туфли"
...
/datum/gear/footwear/jackboots
	display_name = "сапоги"
	path = /obj/item/clothing/shoes/jackboot
	cost = 200
