...
/datum/team/gang/tunnel
	name = "Tunnel"
	color = "#FF00FF"
	inner_outfits = list(/obj/item/clothing/under/suit/charcoal)
...
/datum/team/gang/h
	name = "H"
	color = "#993333"
	inner_outfits = list(/obj/item/clothing/under/color/random)
	outer_outfits = list(/obj/item/clothing/suit/vapeshirt) // perfect

/datum/team/gang/rigatonifamily
	name = "Rigatoni family"
	color = "#cc9900" // p a s t a colored
	inner_outfits = list(/obj/item/clothing/under/rank/civilian)
