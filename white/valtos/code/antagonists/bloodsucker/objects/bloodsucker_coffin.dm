...
/obj/structure/closet/crate/proc/UnclaimCoffin()
	if (resident)
		...
		if (resident.mind)
			...
			to_chat(resident, span_danger("<span class='italics'>You sense that the link with your coffin, your sacred place of rest, has been brokem! You will need to seek another.</span>"))
