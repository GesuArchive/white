...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'white/valtos/sounds/bloodsucker/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
...
/obj/screen/bloodsucker/blood_counter		// NOTE: Look up /obj/screen/devil/soul_counter  in _onclick / hud / human.dm
	icon = 'white/valtos/icons/bloodsucker/fulpicons.dmi'//'icons/mob/screen_gen.dmi'
	name = "Blood Consumed"
