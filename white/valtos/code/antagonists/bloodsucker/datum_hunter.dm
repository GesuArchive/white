...
/datum/action/bloodsucker/trackvamp/
	...
	button_icon = 'white/valtos/icons/bloodsucker/fulpicons.dmi'	//This is the file for the BACKGROUND icon
	background_icon_state = "vamp_power_off"		//And this is the state for the background icon
	icon_icon = 'white/valtos/icons/bloodsucker/fulpicons.dmi'		//This is the file for the ACTION icon
