...
/datum/orbital_objective/assassination/generate_objective_stuff(turf/chosen_turf)
	...
	switch(pick_weight(list("secretagentman" = 1, "dictator" = 1, "operative" = 1, "greytide" = 3, "funnyman" = 2)))
		if("secretagentman")
			flavor_text = "On behalf of your Benefactors, you lead a life of danger - To everyone you meet, you stay a stranger. but you moved too much, took too many chances - \
		...
		if("dictator")
			flavor_text = "It has been months since your regime fell. Once a hero, you're now just someone wishing that they will see the next sunrise. You know those \
		...
		if("greytide")
			flavor_text = "You are just an assistant on a lonely derelict station. You dream of going home, but you broke the wrong airlock - \
			Now your former employer, Nanotrasen, is after you..."
			created_human.equipOutfit(/datum/outfit/vip_target/greytide)
		if("operative")
			flavor_text = "You are a Syndicate operative employed by Cybersun Industries, currently scavenging for valuable resources in the wrecks of Nanotrasen Derelicts. \
		...
		if("funnyman")
			flavor_text = "Slip, slip, slip! Your PDA's brought a lot of laughs to this crew, but now that they're - and it's - gone, the Head Of Security's threats are \
			echoing in your mind..."
			created_human.equipOutfit(/datum/outfit/vip_target/clown)
	created_human.mind.store_memory("[flavor_text] - Someone is out to assassinate you... Stay alive.")
