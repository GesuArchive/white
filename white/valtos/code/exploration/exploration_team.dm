/datum/job/exploration
	...
	skills = list(/datum/skill/ranged = SKILL_EXP_EXPERT, /datum/skill/surgery = SKILL_EXP_JOURNEYMAN)
	minimal_skills = list(/datum/skill/ranged = SKILL_EXP_JOURNEYMAN, /datum/skill/surgery = SKILL_EXP_APPRENTICE)
