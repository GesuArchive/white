/mob/living/simple_animal/hostile/blackmesa/xen/houndeye
	...
	alert_sounds = list(
		'white/valtos/sounds/black_mesa/mobs/houndeye/he_alert1.ogg',
		'white/valtos/sounds/black_mesa/mobs/houndeye/he_alert2.ogg',
		'white/valtos/sounds/black_mesa/mobs/houndeye/he_alert3.ogg',
		'white/valtos/sounds/black_mesa/mobs/houndeye/he_alert4.ogg',
		'white/valtos/sounds/black_mesa/mobs/houndeye/he_alert5.ogg'
	)
	/// Charging ability
