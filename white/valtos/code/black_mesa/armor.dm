/obj/item/clothing/suit/armor/vest/hecu
	...
	unique_reskin = list(
		"Basic" = "combat_vest",
		"Corpsman" = "combat_vest_medic",
		"Basic Black" = "combat_vest_black",
		"Corpsman Black" = "combat_vest_medic_black",
	)
...
/obj/item/clothing/head/helmet/hecu
	...
	unique_reskin = list(
		"Basic" = "combat_helmet",
		"Corpsman" = "combat_helmet_medic",
		"Basic Black" = "combat_helmet_black",
		"Corpsman Black" = "combat_helmet_medic_black",
	)
...
/obj/item/clothing/suit/armor/bulletproof/hecu
	...
	unique_reskin = list(
		"Basic" = "ceramic_vest",
		"Corpsman" = "ceramic_vest_medic",
		"Basic Black" = "ceramic_vest_black",
		"Corpsman Black" = "ceramic_vest_medic_black",
	)
...
/obj/item/clothing/head/helmet/alt/hecu
	...
	unique_reskin = list(
		"Basic" = "ceramic_helmet",
		"Corpsman" = "ceramic_helmet_medic",
		"Basic Black" = "ceramic_helmet_black",
		"Corpsman Black" = "ceramic_helmet_medic_black",
	)
