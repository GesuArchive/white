...
/datum/looping_sound/lambda
	mid_sounds = list('white/valtos/sounds/black_mesa/lc_mainbeam.ogg' = 1)
	mid_length = 8.1 SECONDS
	volume = 100

/obj/effect/bump_teleporter/lambda
	name = "большой телепорт"
	desc = "Супер мощный телепортер, способный телепортировать через измерения."
...
/obj/effect/bump_teleporter/lambda/Bumped(atom/movable/movable_atom)
	...
	playsound(src, 'white/valtos/sounds/black_mesa/lc_teleport.ogg', 100)
