...
/datum/component/aiming/proc/fire() //Todo
	...
	if(isitem(parent))
		...
		user.visible_message("<span class='warning'><b>[user]</b> угрожающе размахивает [parent]!</span>") //lets you still aim at someone with a wrench / knife for epic psycho RP!
		stop_aiming()
