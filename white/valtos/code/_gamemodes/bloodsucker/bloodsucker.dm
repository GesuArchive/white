...
/datum/game_mode
	...
	// LISTS //
	var/list/vassal_allowed_antags = list(/datum/antagonist/traitor, /datum/antagonist/traitor/internal_affairs, /datum/antagonist/survivalist, \
...
/datum/game_mode/bloodsucker
	...
	protected_jobs = list("Security Officer", "Russian Officer", "Trader", "Hacker","Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Deputy")
	required_players = 0
	required_enemies = 1
