...
/obj/machinery/copytech/examine(mob/user)
	...
	. += "<span class='info'>Накоплено энергии: <b>[num2loadingbar((siphon_max-siphoned_power)/siphon_max, 10, reverse = TRUE)] [display_power(siphoned_power)]/[display_power(siphon_max)]</b>.</span>"
