...
/datum/design/pod_core
	...
	materials = list(/datum/material/metal=5000, /datum/material/uranium=1000, /datum/material/plasma=5000)
...
/datum/design/pod_armor_civ
	...
	id = "podarmor_civ"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal=15000,/datum/material/glass=5000,/datum/material/plasma=10000)
...
/datum/design/pod_armor_industrial
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal=15000,/datum/material/glass=5000,/datum/material/plasma=10000,/datum/material/diamond=5000,/datum/material/silver=7500)
...
/datum/design/pod_armor_gold
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal=5000,/datum/material/glass=2500,/datum/material/plasma=7500,/datum/material/gold=10000)
	departmental_flags = DEPARTMENTAL_FLAG_ENGINEERING | DEPARTMENTAL_FLAG_SCIENCE
...
/datum/design/pod_gun_disabler
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal = 15000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_gun_bdisabler
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal = 15000,/datum/material/plasma=2000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_gun_laser
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal=10000,/datum/material/glass=5000,/datum/material/gold=1000,/datum/material/silver=2000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_ka_basic
	...
	id = "pod_ka_basic"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 10000, /datum/material/glass = 5000, /datum/material/silver = 2000, /datum/material/uranium = 2000)
...
/datum/design/pod_ka
	...
	id = "pod_ka"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 10000, /datum/material/glass = 5000, /datum/material/silver = 2000, /datum/material/gold = 2000, /datum/material/diamond = 2000)
...
/datum/design/pod_adv_plasma_cutter
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 10000, /datum/material/glass = 5000, /datum/material/silver = 4000, /datum/material/gold = 4000, /datum/material/diamond = 4000)
...
/datum/design/pod_cargo_ore
	...
	id = "podcargo_ore"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal=20000, /datum/material/glass=2000)
...
/datum/design/passenger_seat
	...
	id = "podcargo_seat"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal=7500, /datum/material/glass=2500)
...
/datum/design/pod_lock_keyed
	...
	id = "podlock_keyed"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal=4500)
...
/datum/design/lockbuster
	...
	category = list("Спейсподы")
	materials = list(/datum/material/metal = 15000, /datum/material/diamond=2500) //it IS a drill!
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
