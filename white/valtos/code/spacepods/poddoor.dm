...
/obj/machinery/door/poddoor/multi_tile/four_tile_ver/
	icon = 'white/valtos/icons/spacepods/doors/1x4blast_vert.dmi'
	bound_height = 128
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/three_tile_ver/
	icon = 'white/valtos/icons/spacepods/doors/1x3blast_vert.dmi'
	bound_height = 96
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/two_tile_ver/
	icon = 'white/valtos/icons/spacepods/doors/1x2blast_vert.dmi'
	bound_height = 64
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/four_tile_hor/
	icon = 'white/valtos/icons/spacepods/doors/1x4blast_hor.dmi'
	bound_width = 128
	dir = EAST

/obj/machinery/door/poddoor/multi_tile/three_tile_hor/
	icon = 'white/valtos/icons/spacepods/doors/1x3blast_hor.dmi'
	bound_width = 96
	dir = EAST
