...
/client/proc/display_tacmap(levels)
	for(var/i=0 to levels)
		SSassets.transport.send_assets(src, "tacmap[i + 2].png")
		src << output("[SSassets.transport.get_asset_url("tacmap[i + 2].png")]", "lobbyprotoc:push_tacmap_image")
