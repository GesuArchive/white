...
/obj/effect/mob_spawn/human/prison/doctor
	name = "доктор"
	flavour_text = "Вы вечный патологоанатом тюрьмы Ромашка. Постарайтесь следить за телами, живые они или нет, и не забывайте готовить мясо для котлет. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b>"
	outfit = /datum/outfit/prison/doctor
	assignedrole = "Doctor USSR"

/obj/effect/mob_spawn/human/prison/chaplain
	name = "пророк"
	flavour_text = "Вы бывший заключенный тюрьмы Ромашка подавшийся в священнослужение. Помогайте чем можете всем нуждающимся. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b>"
	outfit = /datum/outfit/prison/prisoner
	assignedrole = "Prorok USSR"

/obj/effect/mob_spawn/human/prison/vertuhai
	name = "вертухай"
	flavour_text = "Вы вечный смотритель тюрьмы Ромашка. Постарайтесь не убивать зеков без приказа свыше и не забывайте кушать котлеты. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b>"
	outfit = /datum/outfit/prison/vertuhai
	assignedrole = "Vertuhai USSR"

/obj/effect/mob_spawn/human/prison/mehanik
	name = "механик"
	flavour_text = "Вы вечный механик тюрьмы Ромашка. Постарайтесь не взорвать двигатель, починить, что не сломано и не забывайте спрашивать у зеков, когда котлеты будут там. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b>"
	outfit = /datum/outfit/prison/mehanik
	assignedrole = "Mehanik USSR"

/obj/effect/mob_spawn/human/prison/nachalnik
	name = "начальник"
	flavour_text = "Вы вечный надзиратель тюрьмы Ромашка. Постарайтесь привести её в порядок и не забывайте напоминать зекам о том, что котлеты только завтра. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b>"
	icon_state = "spwn"
...
/obj/effect/mob_spawn/human/prison/prisoner
	name = "шконка"
	desc = "Кажется тут кто-то затаился под шконкой..."
	flavour_text = "Вы вечный заключенный тюрьмы Ромашка. Отсиживайте свой тюремный срок как следует, слушайтесь начальника и не забывайте о том, что котлеты только завтра. Убивать и сбегать без особой причины запрещено, иначе Вас забанят. Правила тут работают в полную силу.</b> Кстати, сидишь ты тут за "
	outfit = /datum/outfit/prison/prisoner
