...
/datum/species/android/babulet
	...
	use_skintones = TRUE
	species_traits = list(EYECOLOR,HAIR,FACEHAIR,LIPS,HAS_FLESH)
	inherent_traits = list(TRAIT_ADVANCEDTOOLUSER,TRAIT_TOXIMMUNE,TRAIT_RESISTHEAT,TRAIT_NOBREATH,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_RADIMMUNE,TRAIT_GENELESS,TRAIT_NOFIRE,TRAIT_PIERCEIMMUNE,TRAIT_NOHUNGER,TRAIT_LIMBATTACHMENT,TRAIT_NOCLONELOSS,TRAIT_CAN_USE_FLIGHT_POTION)
