...
/datum/round_event/ghost_role/schoolshooters/spawn_role()
	var/list/funny_names = list("Podjog Saraev", "Rulon Oboev", "Ushat Pomoev", "Barak Mongolov", "Ulov Nalimov", "Zabeg Debilov", "Kompil Bildov", "Razriv Ochkov", "Anban Debilov", "Ali Rezun", "Obser Shtanov", "Krazha Donatov", "Nerf Debilov", "Progib Kozlov")
