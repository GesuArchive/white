...
/obj/machinery/mecha_part_fabricator/engi
	...
	part_sets = list(											// Подклассы:
								...
								"Персональные компьютеры",		//	"Жесткие диски", "Сетевые карты", "Внешние накопители", "Слоты карт", "Утилитарные модули", "Питание и батареи", "Процессоры"
