/obj/item/gun_attachment
    ...
    desc = null
    icon_state = "blyad"
    icon = 'white/rebolution228/icons/weapons/gun_attachments.dmi'

/obj/item/gun_attachment/foregrip
    name = "gun foregrip attachment"

/obj/item/gun_attachment/sight/pso1
    name = "gun sight attachment"

// Sight attachments (optical sights, holographic, etc.)
/obj/item/gun_attachment/sight/pso1
    name = "ПСО-1"
