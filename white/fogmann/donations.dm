...
GLOBAL_LIST_INIT(donations_list, list(
	...
	"Покрывала" = list(
		...
		new /datum/donate_info("Blue Robe",					/obj/item/clothing/suit/cowl/robe,				500),
		new /datum/donate_info("Red Robe",					/obj/item/clothing/suit/cowl/robe/red,			500),
		new /datum/donate_info("Terran Robe",				/obj/item/clothing/suit/cowl/terran,			500),
		new /datum/donate_info("Terran Robe",				/obj/item/clothing/suit/cowl/terran/off,		500),
		new /datum/donate_info("Terran Robe",				/obj/item/clothing/suit/cowl/terran/comm,		500),
