...
/obj/item/nuclear_challenge/lowpop
	...
	desc = "Use to send a declaration of hostilities to the target, delaying your shuttle departure for 10 minutes while they prepare for your assault.  \
			Must be used within five minutes, or your benefactors will lose interest."
	var/declaring_war_lowpop = FALSE
	var/uplink_type_lowpop = /obj/item/uplink/nuclear

/obj/item/nuclear_challenge/lowpop/attack_self(mob/living/user)
	...
	priority_announce(war_declaration, title = "Объявление войны", sound = ANNOUNCER_WAR, has_important_message = TRUE)
...
/obj/item/nuclear_challenge/lowpop/proc/check_allowed_low(mob/living/user)
