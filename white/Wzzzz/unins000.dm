...
/obj/item/clothing/under/vor
	icon = 'white/Wzzzz/clothing/uniforms.dmi'
	worn_icon = 'white/Wzzzz/clothing/mob/uniform.dmi'

/obj/item/clothing/under/vor/white
	name = "white uniform"
	desc = "White like angel."
	icon_state = "white"
	inhand_icon_state = "white"

/obj/item/clothing/under/vor/suit1
	name = "suit"
	desc = "For work."
	icon_state = "suit"
	inhand_icon_state = "suit"

/obj/item/clothing/under/vor/grey
	name = "grey uniform"
	desc = "Grey style."
	icon_state = "grey"
	inhand_icon_state = "grey"

/obj/item/clothing/under/vor/d
	name = "D uniform"
	desc = "D style."
	icon_state = "d"
	inhand_icon_state = "d"

/obj/item/clothing/under/vor/tac
	name = "tactical uniform"
	desc = "Looks some chill for tactics."
	icon_state = "tac"
	inhand_icon_state = "tac"

/obj/item/clothing/under/vor/service_co
...
/obj/item/clothing/under/vor/fservice_co
	name = "service uniform"
	desc = "For service."
	armor = list("melee" = 15, "bullet" = 5, "laser" = 5,"energy" = 5, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 15, "acid" = 15)
...
/obj/item/clothing/under/vor/uniform
	name = "combat uniform"
	desc = "Comfortable and warm"
...
/obj/item/clothing/under/vor/uniform/ct
