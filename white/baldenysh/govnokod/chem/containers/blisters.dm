...
/obj/item/storage/blister/threecap/psicodine
	...
	populate_pill_types = list(/obj/item/reagent_containers/pill/psicodine = 3)
...
//funny meds
/obj/item/storage/blister/fivecir/penthrite
	name = "блистерная упаковка (Пентрит)"
	populate_pill_types = list(/obj/item/reagent_containers/pill/penthrite = 5)

/obj/item/storage/blister/threecap/nooartrium
	name = "блистерная упаковка (Нооартирум)"
