...
/obj/item/paper/tdroid_manual
	...
	info = "<h2>me подкрадывается и ломает четвертую стену</h2>\n \
		азазхвзахвахзазхвазахв вы были затроллены, у вас бивалент!!!\n \
		1.Поинт на себя с дизарм интентом чтобы объединить и сбросить цели нескольких андроидов в радиусе 5 метров в отряд, так они не будут друг друга убивать (в теории)\n  \
		2.Поинт на андроида с дизарм интентом чтобы сбросить его цели и уронить на 5 секунд.\n  \
		3.Поинт на живое существо не в отряде с дизарм интентом чтобы андроиды начали приказывать ему сдаться, и в случае неподчинения начинали производить распидорас.\n  \
		3.1 Поинт на живое существо не в отряде с харм интентом чтобы андроиды начали сразу производить его распидорас.\n  \
		3.2 Поинт на живое существо не в отряде с харм интентом два раза чтобы андроиды начали производить его распидорас насмерть.\n  \
		4.Поинт на андроида с граб интентом для перехода в режим приказов конкретно этому андроиду.\n  \
		4.1 Поинт на объект с граб интентом для следования за ним. В случае, когда объект это другой андроид из отряда - первый андроид его схватит и потащит.\n  \
		"
