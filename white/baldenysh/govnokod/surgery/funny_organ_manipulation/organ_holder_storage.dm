/datum/component/storage/concrete/multi/organ_holder
	max_items = 20
...
/datum/component/storage/concrete/multi/organ_holder/Initialize()
	. = ..()
...
/datum/component/storage/concrete/multi/organ_holder/canreach_react(datum/source, list/next)
	. = ..()
	var/atom/A = parent
	if(ismob(A.loc))
		next += A.loc
