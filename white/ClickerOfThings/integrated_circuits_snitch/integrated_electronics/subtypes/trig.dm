...
/obj/item/integrated_circuit_old/trig
	complexity = 1
	inputs = list(
		"A" = IC_PINTYPE_NUMBER,
		"B" = IC_PINTYPE_NUMBER,
...
/obj/item/integrated_circuit_old/trig/sine
	name = "sin circuit"
...
/obj/item/integrated_circuit_old/trig/sine/do_work()
	pull_data()
	var/result = null
...
/obj/item/integrated_circuit_old/trig/cosine
	name = "cos circuit"
...
/obj/item/integrated_circuit_old/trig/cosine/do_work()
	pull_data()
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
	if(!isnull(A))
...
/obj/item/integrated_circuit_old/trig/tangent
	name = "tan circuit"
...
/obj/item/integrated_circuit_old/trig/tangent/do_work()
	pull_data()
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
	if(!isnull(A))
...
/obj/item/integrated_circuit_old/trig/cosecant
...
/obj/item/integrated_circuit_old/trig/cosecant/do_work()
	pull_data()
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
	if(!isnull(A))
...
/obj/item/integrated_circuit_old/trig/secant
...
/obj/item/integrated_circuit_old/trig/secant/do_work()
	pull_data()
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
	if(!isnull(A))
...
/obj/item/integrated_circuit_old/trig/cotangent
...
/obj/item/integrated_circuit_old/trig/cotangent/do_work()
	pull_data()
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
	if(!isnull(A))
