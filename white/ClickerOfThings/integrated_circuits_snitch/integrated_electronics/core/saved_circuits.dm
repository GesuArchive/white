...
/datum/controller/subsystem/processing/circuit/proc/validate_electronic_assembly(program)
	...
	blocks["metal_cost"] = assembly.custom_materials[GET_MATERIAL_REF(/datum/material/iron)]
	...
	for(var/C in blocks["components"])
		...
		blocks["metal_cost"] += component.custom_materials[GET_MATERIAL_REF(/datum/material/iron)]
