@REM Script to easily upload white.rsc to your FTP-server so that clients download it from an
...
@REM Replace FOLDER/FOLDER with the folder on the FTP server where you want to store white.rsc, for example: cd www/rsc
@REM Replace FTP.DOMAIN.COM with the IP-address or domain name of your FTP server
@REM Add the URL to the location of white.rsc on your webserver into data\external_rsc_urls.txt
@REM
@echo off
